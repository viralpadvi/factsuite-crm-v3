...
function get_roles_list() {
    $.ajax({
        type: "POST",
        url: base_url+"factsuite-specialist/get-roles-list", 
        dataType: "json",
        data : {
            verify_specialist_request : 1
        },
...
function get_roles_person_list() {
    $.ajax({
        type: "POST",
        url: base_url+"factsuite-specialist/get-roles-person-list", 
        dataType: "json",
        data : {
            verify_specialist_request : 1,
...
function raise_new_ticket() {
    ...
    if (check_assigned_to_role_var == 1 && check_assigned_to_person_var == 1 && check_ticket_subject_var == 1 && ticket_description != '') {
        ...
        $.ajax({
            type: "POST",
            url: base_url+"factsuite-specialist/raise-new-ticket",
            data:formdata,
            dataType: 'json',
            contentType: false,
            processData: false,
