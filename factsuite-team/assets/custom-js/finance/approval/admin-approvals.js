...
function get_all_raised_tickets() {
	$.ajax({
        type : "POST",
        url : base_url+"Approval_Mechanisms/get_approval_list_for_finance",
        data : {
            ...
            if (data.length > 0) {
                for (var i = 0; i < all_tickets.length; i++) {
                    ...
                    if (all_tickets[i].level_two_status =='1') {
                     ...
                     var status = 'Pending';
                    if (all_tickets[i].approval_status =='1') {
                        status = 'Accepted';
                    }else if(all_tickets[i].approval_status =='2') {
                        status = 'Rejected';
                    }
                    ...
                    html += '<td id="ticket-status_one-'+all_tickets[i].approval_id+'">'+status_one+'</td>';
                    html += '<td id="ticket-status_two-'+all_tickets[i].approval_id+'">'+status_two+'</td>';
