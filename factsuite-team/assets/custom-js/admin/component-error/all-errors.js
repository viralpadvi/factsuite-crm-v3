function view_all_error_logs(candidate_id,component_id,component_index) {
	...
	$.ajax({
        type : "POST",
        url : base_url+"factsuite-admin/get-all-error-log",
        data : formdata,
        contentType : false,
        processData : false,
        dataType : "json",
...
function add_new_error_comment(user_filled_details_component_error_id) {
    ...
    if (note_message != '') {
        ...
        $.ajax({
            type : "POST",
            url : base_url+"factsuite-admin/add-new-error-comment",
            data : {
...
function show_new_comment(user_filled_details_component_error_id,comment_id) {
    $.ajax({
        type : "POST",
        url : base_url+"factsuite-admin/get-error-single-comment",
        data : {
        	verify_admin_request : 1,
            user_filled_details_component_error_id : user_filled_details_component_error_id,
...
function show_all_comments(user_filled_details_component_error_id,request_from = '') {
    ...
    $.ajax({
        type : "POST",
        url : base_url+"factsuite-admin/get-single-error-all-comments",
        data : {
        	verify_admin_request : 1,
            user_filled_details_component_error_id : user_filled_details_component_error_id
        },
