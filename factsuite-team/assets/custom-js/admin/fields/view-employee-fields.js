...
function addfieldvalues(){
	...
	if(field_value != ''){
		$.ajax({
		type: "POST",
	  	url: base_url+"dynamicFields/insert_employee_field_values",
	  	data:{
...
function addfield(){
	...
	if(field_name != ''){
		$.ajax({
		type: "POST",
	  	url: base_url+"dynamicFields/insert_employee_field",
	  	data:{
...
function edit_field_value(id){
  ...
  $.ajax({
    type: "POST",
    url: base_url+"dynamicFields/get_employee_field_details/"+id, 
    dataType: "json",
    success: function(data){  
    	var count = $("#total_fields").val();
			var names = $("#total_field_name").val();
...
function updateData(){
	...
	if(field_value != '' && dynamic_id !=''){
		$.ajax({
		type: "POST",
	  	url: base_url+"dynamicFields/update_employee_field_values",
	  	data:{
