...
function get_ticket_priority_list() {
    $.ajax({
        type: "POST",
        url: base_url+"factsuite-tech-support/get-ticket-priority-list", 
        dataType: "json",
        data : {
...
function get_ticket_classification_list() {
    $.ajax({
        type: "POST",
        url: base_url+"factsuite-tech-support/get-ticket-classification-list",
        data : {
            verify_tech_support_request : 1
        },
        dataType: "json",
...
function get_roles_list() {
    $.ajax({
        type: "POST",
        url: base_url+"factsuite-tech-support/get-roles-list", 
        dataType: "json",
        data : {
            verify_tech_support_request : 1
        },
...
function get_roles_person_list() {
    $.ajax({
        type: "POST",
        url: base_url+"factsuite-tech-support/get-roles-person-list", 
        dataType: "json",
        data : {
            verify_tech_support_request : 1,
...
function raise_new_ticket() {
    ...
    if (check_assigned_to_role_var == 1 && check_assigned_to_person_var == 1 && check_ticket_subject_var == 1 && ticket_description != '') {
        ...
        formdata.append('verify_tech_support_request',1);
        ...
        $.ajax({
            type: "POST",
            url: base_url+"factsuite-tech-support/raise-new-ticket",
            data:formdata,
            dataType: 'json',
            contentType: false,
            processData: false,
