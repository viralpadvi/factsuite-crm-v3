      ...
      if (data.length > 0) {
        ...
        for (var i = 0; i < data.length; i++) { 
            ...
            if(data[i].priority == '0'){
                priority = '<span class="text-info font-weight-bold">Low priority</span>'
            }else if(data[i].priority == '1'){  
                priority = '<span class="text-warning font-weight-bold">Medium priority</span>'
            }else if(data[i].priority == '2'){  
                priority = '<span class="text-danger font-weight-bold">High priority</span>'
            }
        	...
        	html += '<tr id="tr_'+data[i].candidate_id+'">'; 
            	...
            	html += '<td id="inputQc_name+'+data[i].candidate_id+'">'+data[i].team_first_name+' '+data[i].team_last_name+'</td>'; 
                // html += '<td class="text-center"><a href="#" onclick="view_case_progress('+data[i].candidate_id+')"><i class="fa fa-eye"></i></a></td>';
            	html += '<td class="text-center"><a href="'+base_url+'factsuite-csm/view-case-detail/'+data[i].candidate_id+'" ><i class="fa fa-eye"></i></a></div></td>';
        ...
        html+='<tr><td colspan="11" class="text-center">No Case Found.</td></tr>'; 
    }
    ...
    $.ajax({
        ...
        success: function(data){ 
            ...
            if (data.length > 0) {
                ...
                let html='';
                html += '<li style="display: inline;" class="active">';
                ...
                for(var i=0;i<data.length;i++){
                    ...
                    html += '<li style="display: inline;" class="'+status+'">';
                    html += '   <div class="view-tp">';
                ...
                html += '<li style="display: inline;" class="deadline">';
                    html += '<div class="view-btm">';
