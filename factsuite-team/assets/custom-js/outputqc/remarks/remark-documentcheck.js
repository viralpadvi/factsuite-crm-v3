...
function documentCheck(){
	$('#wait-message').html('Please,Wait we are updateg your data.')
 	...
 	$('#submit-doc-data').html('<i class="fa fa-circle-o-notch fa-spin"></i> Loading');
  	...
  	var candidate_id_hidden = $('#candidate_id_hidden').val();
   	// alert('candidate_id_hidden : '+candidate_id_hidden)
	...
	// alert('pincode : '+JSON.stringify(pincode))
...
$("#submit-doc-data").html('<div class="spinner-grow text-success spinner-grow-sm" role="status"><span class="sr-only">Loading...</span></div>Loading...');

	$.ajax({
        type: "POST",
          url: base_url+"outPutQc/remarkForDocuemtCheck",
          data:formdata,
          dataType: 'json',
          contentType: false,
          processData: false,
