...
function get_all_assigned_tickets() {
	$.ajax({
        type : "POST",
        url : base_url+"factsuite-am/get-all-assigned-tickets",
        data : {
            verify_am_request : 1
        },
        dataType: "json",
...
function view_ticket_details(ticket_id) {
    $.ajax({
        type : "POST",
        url : base_url+"factsuite-am/get-ticket-details",
        data : {
            ticket_id : ticket_id,
            verify_am_request : 1
        },
...
function update_ticket_status(ticket_id) {
    ...
    $.ajax({
        type : "POST",
        url : base_url+"factsuite-am/update-ticket-status",
        data : {
            ticket_id : ticket_id,
...
function add_new_ticket_comment(ticket_id) {
    ...
    if (note_message != '') {
        ...
        $.ajax({
            type : "POST",
            url : base_url+"factsuite-am/add-new-ticket-comment",
            data : {
                ticket_id : ticket_id,
...
function show_new_comment(ticket_id,comment_id) {
    $.ajax({
        type : "POST",
        url : base_url+"factsuite-am/get-ticket-single-comment",
        data : {
            ticket_id : ticket_id,
...
function show_all_comments(ticket_id) {
    ...
    $.ajax({
        type : "POST",
        url : base_url+"factsuite-am/get-single-ticket-all-comments",
        data : {
            ticket_id : ticket_id,
            verify_am_request : 1
        },
