...
function view_ticket_details(approval_id) {
    $.ajax({
        ...
        success: function(data) {
            ...
            // $('#show-ticket-status-modal').html(ticket_status);
            $('#submit-new-note').attr('onclick','add_new_ticket_comment('+ticket_details.approval_id+')');
            $('#refresh-chat-btn').attr('onclick','show_all_comments('+ticket_details.approval_id+',"refresh_chat")');
