...
// 	$.ajax({
// 		type: "POST",
// 	  	url: base_url+"analyst/getQcErrorComponent", 
//         data:{
//             notifcation:'1'
//         },
// 	  	dataType: "json",
...
//             	html += '<td class="text-center"><a href="'+base_url+'factsuite-analyst/component-detail/'+arg+'" class="app-btn">View <i class="fas fa-angle-right"></i></a></td>';
