...
function global_sanctions_aml(){
  ...
  formdata.append('component_name','Global Sanctions/ AML');
	...
	$("#wait-message").html("<span class='text-warning'>Please wait while we are updating the data.</span>");
		$.ajax({
            type: "POST",
              url: base_url+"analyst/update_remarks_global_sanctions_aml",
              data:formdata,
              dataType: 'json',
              contentType: false,
              processData: false,
