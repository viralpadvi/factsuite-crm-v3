...
function globalDb(){
	...
	var globaldatabase_id = $("#globaldatabase_id").val();
	...
	formdata.append('globaldatabase_id',globaldatabase_id);
	...
	$.ajax({
        type: "POST",
          url: base_url+"analyst/update_gd_remarks",
          data:formdata,
          dataType: 'json',
          contentType: false,
          processData: false,
...
$("#view_vendor_log").on('click',function(){
	...
	var component_id = $("#globaldatabase_id").val();
