...
function globalDb(){
	...
	formdata.append('component_name','India Civil Litigation');
	...
	$.ajax({
        type: "POST",
          url: base_url+"analyst/update_india_civil_litigation_remarks",
          data:formdata,
          dataType: 'json',
          contentType: false,
          processData: false,
...
$("#view_vendor_log").on('click',function(){
	...
	var component_id = $("#india_civil_litigation_id").val();
