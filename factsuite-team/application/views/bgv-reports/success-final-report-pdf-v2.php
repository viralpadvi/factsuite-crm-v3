        ...
        <div class="container-fluid bg-gray">
            ...
            <table class="table" cellspacing="0">
                <tr>
                    ...
                    <td class="report-details-td report-details-td-2 report-details-width-2">'.$candidate_details['candidate_id'].'</td>
                </tr>
                <tr>
                 ...
                 <tr>
                    ...
                    <td class="report-details-td report-details-td-2">'.ucwords($client_details['client_name']).'</td>
                </tr>
                <tr>
                    <td colspan="2"><hr class="hr"></td>
                </tr>
                ...
                <tr>
                    ...
                    <td class="report-details-td report-details-td-2 report-details-width-2">'.get_date(isset($candidate_details['case_submitted_date'])?$candidate_details['case_submitted_date']:$candidate_details['created_date']).'</td>
                </tr>
                <tr>
                    <td colspan="2"><hr class="hr"></td>
                </tr>
                <tr>
                    ...
                    <td class="report-details-td report-details-td-2 report-details-width-2">'.get_date($candidate_details['report_generated_date']).'</td>
                </tr>';
                ...
                <tr>
                    ...
                    <td class="report-details-td report-details-td-2 report-details-width-2">'.get_date($candidate_details['date_of_joining']).'</td>
                </tr>';
...
$html .='<div class="container-fluid margin-1 bg-gray">
            ...
            <table class="table" cellspacing="0">
                ...
                <tr>
                    ...
                    <td class="report-details-td report-details-td-2 report-details-width-2">'.get_date($candidate_details['date_of_birth']).'</td>
                </tr>
                <tr>
                    <td colspan="2"><hr class="hr"></td>
                </tr>';
            ...
            $html .='<tr>
                ...
                $html .='<tr>
                    ...
                    <td class="report-details-td report-details-td-2 report-details-width-2">Mr. '.ucwords($candidate_details['father_name']).'</td>
                </tr>
            </table>
        </div>
...
$start_end = get_date($start).' - '.get_date($end);
 ...
 $remark_reason_for_leaving = isset($table['current_employment']['remark_reason_for_leaving'])?$table['current_employment']['remark_reason_for_leaving']:'-';
...
$html .='<td colspan="2">'.$remark_reason_for_leaving.'</td>';
$html .='<td style="color: '.$color_code.'; " >'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td>8</td>';
