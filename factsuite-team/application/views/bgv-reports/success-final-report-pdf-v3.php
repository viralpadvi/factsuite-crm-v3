...
$tv_or_ebgv = isset($client_details['tv_or_ebgv'])?$client_details['tv_or_ebgv']:'0'; 
...
$package = $this->db->where('package_id',$candidate_details['package_name'])->get('packages')->row_array();
...
$title = isset($candidate_details['title'])?ucfirst($candidate_details['title']):'';
$candidate_final_name = $title.' '.$candidate_details['first_name'].' '.$candidate_details['last_name'];
$employee = 'NA';

if ($candidate_details['employee_id'] !='') {
   $employee = $candidate_details['employee_id'];
}
...
<head>
    ...
    <style type="text/css">
        ...
        /*new*/
        .pg-hd{ color:#5a3b81; font-size:25px; text-align:center; font-weight:bold; padding:15px 0px 25px 0px;}
.pg-hd2{ color:#333; font-size:25px; text-align:left; font-weight:bold; padding:15px 0px 25px 0px;}
.pg-hd3{ color:#333; font-size:25px; text-align: center; font-weight:bold; padding:25px 0px 50px 0px;}
.tbl1{ border:2px solid #000; border-radius:10px; margin-bottom:15px;}
.tbl2{ border:2px solid #000; border-radius:10px; margin-bottom:15px; background-color:#f8f8f8; padding:30px;}
.tbl-hd{ color:#000; background-color:#dddddd; font-size:21px; font-weight:bold; padding:15px; border-radius:10px 10px 0px 0px;}
.tbl-hd1{ color:#000; background-color:#dddddd; font-size:21px; font-weight:bold; padding:15px; border-radius:10px 0px 0px 0px;}
.tbl-hd2{ color:#666; background-color:#dddddd; font-size:21px; font-weight:normal; padding:15px; border-radius:0px 10px 0px 0px; text-align:right;}
.tbl-hd2 strong{color:#1e7705;}
.tbl-tx1{ padding:15px; color:#000; font-size:15px; background-color:#f1f1f1;}
.tbl-tx2{ padding:15px; color:#000; font-size:15px; background-color:#f1f1f1; border-radius:0px 0px 0px 10px;}
.brd-b{ border-bottom:2px solid #dddddd;}
.brd-l{ border-left:4px solid #dddddd;}
.brd-r{ border-right:4px solid #dddddd;}
.tbl-tx3{ padding:15px; color:#000; font-size:15px; font-weight:bold;background-color:#ffffff;}
.grn-btn{ text-align:center; padding:15px;}
.grn-btn a{ display:block; color:#FFF; text-align:center; text-transform:uppercase; background-color:#1e7705; border-radius:25px; padding:12px 0px;
 text-decoration:none; font-size:14px;}
.tbl-tx4{ padding:15px; color:#000; font-size:15px;}
.tbl-hd4{ background-color:#5a3b81; color:#FFF; font-size:16px; font-weight:bold; padding:15px;}
.grn-txt{ color:#1e7705; font-size:14px; font-weight:bold; padding:15px;}
.aux-hd{ text-transform:uppercase; color:#424145; font-weight:bold; padding:15px;}
.aux-txt1{ font-weight:bold; font-size:14px; color:#424145; padding:15px;}
.aux-txt2{ font-weight: normal; font-size:14px; color:#424145; padding:15px;}
.dsc-hd{ padding:0px 15px; font-size:18px; font-weight:bold;}
.dsc-txt{ padding:15px; font-size:16px; color:#333; line-height:25px;}

.ftr-txt{ text-align:center; color:#000; font-weight:bold; font-size:13px; line-height:30px; border-top:2px solid #000; padding-top:10px;}
.ftr-txt a{ text-decoration:none; color:#000; display:inline-block;}
.ftr-txt a:hover{color:#5a3b81;}
...
<body>
    ...
    <main>
       ...
       <div class="container-fluid bg-gray">
            <div class="info-div-txt padding-all">Case Details</div>
            <table class="table" cellspacing="0">
            <tr>
                <td width="25%" class="tbl-tx1 brd-b brd-r">Case ID</td>
                <td width="25%" class="tbl-tx3 brd-b brd-r">'.$candidate_details['candidate_id'].'</td>
                <td width="25%" class="tbl-tx1 brd-b brd-r">Requested Date</td>
                <td width="25%" class="tbl-tx3 brd-b">'.get_date($candidate_details['case_submitted_date']).'</td> 
                  
            </tr>
            <tr>';
             if ($tv_or_ebgv !='1') {
            $html .='<td class="tbl-tx1 brd-r">Date of Joining</td>
                <td class="tbl-tx3 ">'.get_date($candidate_details['date_of_joining']).'</td>';
            }else{
            $html .='<td class="tbl-tx2 brd-r"></td>
                    <td class="tbl-tx3 brd-r"></td>';     
            }
               $html .='<td class="tbl-tx1 brd-b brd-r">Completed Date</td>
                <td class="tbl-tx3 brd-r">'.get_date($candidate_details['report_generated_date']).'</td>
            </tr>
               <tr>
                <td width="25%" class="tbl-tx2 brd-r">Package Name</td>
                <td colspan="3" class="tbl-tx1 td-bg border-r">'.ucwords($package['package_name']).'</td>
                </tr>
                ';
...
$html .='<div class="container-fluid margin-1 bg-gray">
            <div class="info-div-txt padding-all">Personal Details</div>
            <table class="table" cellspacing="0">
                
                <tr>
        <td width="25%" class="tbl-tx1 brd-b brd-r">Client Name</td>
        <td colspan="3" class="tbl-tx3 brd-b">'.ucwords($client_details['client_name']).'</td>
        </tr>
      <tr>
        <td width="25%" class="tbl-tx1 brd-b brd-r">Candidate Name</td>
        <td width="25%" class="tbl-tx3 brd-b brd-r">'.ucwords($candidate_final_name).'</td>
        <td width="25%" class="tbl-tx1 brd-b brd-r">Date of Birth</td>
        <td width="25%" class="tbl-tx3 brd-b">'.get_date($candidate_details['date_of_birth']).'</td>
      </tr>
      <tr>';
         if ($tv_or_ebgv !='1') {
        $html .='<td class="tbl-tx2 brd-r">Employee ID</td>
        <td class="tbl-tx3 brd-r">'.$employee.'</td>';
        }else{
        $html .='<td class="tbl-tx2 brd-r"></td>
                <td class="tbl-tx3 brd-r"></td>';     
        }
        $html .='<td class="tbl-tx1 brd-r">Father\'s Name</td>
        <td class="tbl-tx3 border-r">Mr. '.ucwords($candidate_details['father_name']).'</td>
      </tr>
            </table>
        </div>';
...
if ($candidate_details['candidate_details_added_from'] == 0) {
    $factsuite_main_website = $this->load_Database_Model->load_database();
    $website_purchased_package_details = $factsuite_main_website->where('cart_id',$candidate_details['package_name'])->get('package_cart')->row_array();
...
$html .='<div class="container-fluid margin-1 bg-gray">
            <div class="info-div-txt info-div-txt-2 padding-all">Verification Result</div>
            <table  class="table" cellspacing="0" >
                <tr>
                   
                  
                                <td class="classification-and-report-result-txt td-bg brdr-r">
                                    Report Classification:
                                </td>
                                <td class="report-details-td td-bg brd-b brd-r">
                                    <span class="classification-red margin-right-1" style="background : '.$color_code.'">'.$text_status.'</span>
                                </td>

                                
                                <td class="classification-and-report-result-txt td-bg">
                                    Report Result:
                                </td>
                                <td class="report-details-td td-bg border-r">
...
$html .='<div class="container-fluid margin-1 bg-gray">
            <table class="table">
                <tr>
                    <td>
                        <span class="report-details-td-3 padding-all">Executive Summary</span>
                    </td>
                    <td class="text-right">
            ...
            <table class="table-2" cellspacing="0">
                <tr>
                    <th class="sr-no brd-r">#</th>
                    <th width="60%" class="brd-r">Component Type</th>
                    <th class="brd-r">Status</th>
                    <th >Result</th>
                </tr>';
   ...
   if (isset($_GET['components'])) {
    $component_get = explode(',', urldecode($_GET['components']));
    // $this->analystModel->insert_report_component_lists($candidate_details['candidate_id'],$component_get);
   }                     
    ...
    if (in_array($value1['component_id'],[1,2,3,4,7,10,11,12,27])) {
      ...
      $component_name = $value1['component_name'].' '.$value1['formNumber'];
        ...
        }else if($value1['component_id'] == '27'){
              $component_name = isset($value1['value_type'])?$value1['value_type']:''; 
        }
    }else{
   ...
   /*  if ($sl==2) {
    ...
    $html .='<tr >';
     $html .='<td class="sr-no td-bg brd-r">'.($sl++).'</td>';
    $html .='<td class="td-bg brd-r"  width="60%">';
    $html .=$component_name;
    $html .='</td>'; 
    $html .='<td class="td-bg brd-r"><span class="component-status text-green">';
    $html .= $status;   
    $html .='</span></td>';
    $html .='<td class="td-bg brd-r"><span class="component-status-result text-green">'; 
    $html .=$verify; 
    $html .='</span></td>';
    $html .='</tr>';
...
$html .='<div class="container-fluid margin-1 bg-gray">
            <table class="table">
                <tr>
                    ...
                    <td class="text-right padding-all">
            ...
            <table class="table-2" cellspacing="0">
                <tr>
                    <th class="sr-no td-bg brd-r">#</th>
                    <th class="td-bg brd-r">Particulars</th>
                    <th colspan="2" class="td-bg brd-r">Details</th> 
                    <th>Result</th>
                </tr>';
            ...
            $remark_gender_r =  $candidate_details['gender'];
            ...
            if (strtolower($pincode_sub) != strtolower($re_pincode_sub) && strtolower($re_pincode_sub) !='' && strtolower($re_pincode_sub) !='na') {
           ...
           $html .='<tr><td class="sr-no td-bg brd-r">1.</td>';
            $html .='<td class="td-bg brd-r">'.$Address_title_name.'</td>';
            $html .='<td colspan="2" class="td-bg brd-r">'.$address_sub.'</td>'; 
            $html .='<td   class="td-bg brd-r">'.$address_img.'</td>';
            $html .='</tr>';

            $html .='<tr><td class="sr-no td-bg brd-r">2.</td>';
            $html .='<td class="td-bg brd-r">'.$City_title_name.'</td>
            <td colspan="2" class="td-bg brd-r">'.$city_sub.'</td>'; 
            $html .='<td   class="td-bg brd-r">'.$city_img.'</td>';
            $html .='</tr>';

           $html .='<tr><td class="sr-no td-bg brd-r">3.</td>';
            $html .='<td  class="td-bg brd-r">'.$State_title_name.'</td>';
            $html .='<td colspan="2" class="td-bg brd-r">'.$state_sub.'</td>'; 
            $html .='<td style="color: '.$color_code.';"  class="td-bg brd-r">'.$states_img.'</td>';
            $html .='</tr>';

           $html .='<tr><td class="sr-no td-bg brd-r">4.</td>';
            $html .='<td  class="td-bg brd-r">'.$Pincode_title_name.'</td>';
            $html .='<td colspan="2" class="td-bg brd-r">'. $pincode_sub.'</td>'; 
            $html .='<td   style="color: '.$color_code.'; "  class="td-bg brd-r">'.$pin_code_img.'</td>';
            $html .='</tr>';

           $html .='<tr><td class="sr-no td-bg brd-r">5.</td>';
            $html .='<td  class="td-bg brd-r">Duration of Stay</td>';
            $html .='<td colspan="2" class="td-bg brd-r">'. $remark_period_of_stay_r.'</td>'; 
            $html .='<td   style="color: '.$color_code.'; "  class="td-bg brd-r">'.$checks_stay.'</td>';
            $html .='</tr>';

           $html .='<tr><td class="sr-no td-bg brd-r">6.</td>';
            $html .='<td  class="td-bg brd-r">Gender</td>';
            $html .='<td colspan="2" class="td-bg brd-r">'. $remark_gender_r.'</td>'; 
            $html .='<td   style="color: '.$color_code.'; "  class="td-bg brd-r"> </td>';
            $html .='</tr>';

     
           $html .='<tr><td class="sr-no td-bg brd-r">7.</td>';
            $html .='<td  class="td-bg brd-r">Verified Date</td>';
            $html .='<td colspan="2" class="td-bg brd-r">'.get_date($verified_dates).'</td>'; 
            $html .='<td style="color: '.$color_code.'; " class="td-bg brd-r"></td>';
            $html .='</tr>';

            $html .='<tr><td class="sr-no td-bg brd-r brdr-r">8.</td>';
            $html .='<td  class="td-bg brd-r">Verification Remarks </td>';
            $html .='<td colspan="2" class="td-bg brd-r">'. $remarks.'</td>'; 
            $html .='<td   style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
            $html .='</tr>';
...
$html .='<div class="container-fluid margin-1 bg-gray">
            ...
            <table class="table-2" cellspacing="0">
                <tr>
                    <th class="sr-no td-bg brd-r">#</th>
                    <th class="td-bg brd-r">Particulars</th>
                    <th width="40%;" class="td-bg brd-r">Details</th> 
                    <th>Result</th>
                </tr>';
           ...
           $html .='<tr><td class="sr-no td-bg brd-r">1.</td>';
            $html .='<td class="td-bg brd-r">'.$Address_title_name.'</td>';
            $html .='<td width="40%;" class="td-bg brd-r">'.$address_sub.'</td>'; 
            $html .='<td class="td-bg brd-r">'.$address_img.'</td>';
            $html .='</tr>';

            $html .='<tr><td class="sr-no td-bg brd-r">2.</td>';
            $html .='<td class="td-bg brd-r">'.$City_title_name.'</td>
            <td width="40%;" class="td-bg brd-r">'.$city_sub.'</td>'; 
            $html .='<td class="td-bg brd-r">'.$city_img.'</td>';
            $html .='</tr>';

           $html .='<tr><td class="sr-no td-bg brd-r">3.</td>';
            $html .='<td class="td-bg brd-r">'.$State_title_name.'</td>';
            $html .='<td width="40%;" class="td-bg brd-r">'.$state_sub.'</td>'; 
            $html .='<td style="color: '.$color_code.';"  class="td-bg brd-r">'.$states_img.'</td>';
            $html .='</tr>';

           $html .='<tr><td class="sr-no td-bg brd-r">4.</td>';
            $html .='<td class="td-bg brd-r">'.$Pincode_title_name.'</td>';
            $html .='<td width="40%;" class="td-bg brd-r">'. $pincode_sub.'</td>'; 
            $html .='<td   style="color: '.$color_code.'; "  class="td-bg brd-r">'.$pin_code_img.'</td>';
            $html .='</tr>';

            $html .='<tr><td class="sr-no td-bg brd-r">5.</td>';
            $html .='<td class="td-bg brd-r">Verified Date</td>';
            $html .='<td width="40%;" class="td-bg brd-r">'.get_date($verified_dates).'</td>'; 
            $html .='<td style="color: '.$color_code.'; " class="td-bg brd-r"></td>';
            $html .='</tr>';

            $html .='<tr><td class="sr-no td-bg brd-r brdr-r">6.</td>';
            $html .='<td class="td-bg brd-r">Verification Remarks </td>';
            $html .='<td width="40%;" class="td-bg brd-r">'. $remarks.'</td>'; 
            $html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
            $html .='</tr>';
...
$doc_display ='';
$doc_display .='<tr>';
$doc_display .='<td  class="td-bg brd-r">1</td>';
$doc_display .='<td  class="td-bg brd-r">Aadhar Number</td>';
$doc_display .='<td colspan="2" class="td-bg brd-r">'.$aadhar_number.'</td>'; 
$doc_display .='<td style="color: '.$color_code.';"   class="td-bg brd-r"> '.$check16px.'</td>';
$doc_display .='</tr>';
                
 $html .= $doc_display;

$html .='<tr>';
$html .='<td  class="td-bg brd-r">2</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($verified_dates).'</td>'; 
$html .='<td style="color: '.$color_code.';"   class="td-bg brd-r"></td>';
$html .='</tr>';
...
$doc_display .='<tr>';
$doc_display .='<td  class="td-bg brd-r">1</td>';
$doc_display .='<td  class="td-bg brd-r">Pan Card</td>';
$doc_display .='<td colspan="2" class="td-bg brd-r">'.$pan_number.'</td>'; 
$doc_display .='<td style="color: '.$color_code.';"   class="td-bg brd-r"> '.$check16px.'</td>';
$doc_display .='</tr>';
...
$html .='<tr>';
$html .='<td  class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($verified_dates).'</td>'; 
$html .='<td style="color: '.$color_code.';"   class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$doc_display .='<tr>';
$doc_display .='<td  class="td-bg brd-r">1</td>';
$doc_display .='<td  class="td-bg brd-r">Passport</td>';
$doc_display .='<td colspan="2" class="td-bg brd-r">'.$passport_number.'</td>'; 
$doc_display .='<td style="color: '.$color_code.';"   class="td-bg brd-r">'.$check16px.'</td>';
$doc_display .='</tr>';
...
$doc_display .='<tr>';
$doc_display .='<td  class="td-bg brd-r">1</td>';
$doc_display .='<td  class="td-bg brd-r">Voter ID Number</td>';
$doc_display .='<td colspan="2" class="td-bg brd-r">'.$voter_id.'</td>'; 
$doc_display .='<td style="color: '.$color_code.';"   class="td-bg brd-r">'.$check16px.'</td>';
$doc_display .='</tr>';
...
$doc_display .='<tr>';
$doc_display .='<td  class="td-bg brd-r">1</td>'; 
$doc_display .='<td  class="td-bg brd-r">SSN Number</td>';
$doc_display .='<td colspan="2" class="td-bg brd-r">'.$ssn_number.'</td>'; 
$doc_display .='<td style="color: '.$color_code.';"   class="td-bg brd-r">'.$check16px.'</td>';
$doc_display .='</tr>';
...
$html .='<tr>';
$html .='<td  class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Drug Panel</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$drug[$key]['drug_test_type_name'].'</td>';

$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td  class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Verified Date</td>';
...
$html .='<tr>';
$html .='<td  class="td-bg brd-r brdr-r">3</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$vremark.'</td>';
...
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['globaldatabase']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';

$html .='<tr>'; 
$html .='<td class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['globaldatabase']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Designation</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$desigination.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$desigination_img.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Department</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$department.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$department_img.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">3</td>';
$html .='<td  class="td-bg brd-r">Employee ID</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$employee_id.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$remarks_emp.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">4</td>';
$html .='<td  class="td-bg brd-r">Company Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$company.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
 
$html .='<tr>';
$html .='<td class="td-bg brd-r">5</td>';
$html .='<td  class="td-bg brd-r">Currency Of Salary</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_currency.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">6</td>';
$html .='<td  class="td-bg brd-r">Annual CTC</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$ctc.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';


$html .='<tr>';
$html .='<td class="td-bg brd-r">7</td>';
$html .='<td  class="td-bg brd-r">Reason For Leaving</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$leaves.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">8</td>';
$html .='<td  class="td-bg brd-r">Joining - Relieving Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$start_end.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$start_end_rs.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">9</td>';
$html .='<td  class="td-bg brd-r">Reporting Manager Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_hr_name.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">10</td>';
$html .='<td  class="td-bg brd-r">Reporting Manager Designation</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remarks_designation.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
 
$html .='<tr>';
$html .='<td class="td-bg brd-r">11</td>';
$html .='<td  class="td-bg brd-r">Eligible for rehire</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_eligible_for_re_hire.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$attendance_punctuality = "NA";
if (trim($remark_attendance_punctuality) !='did_not_comment') {
   $attendance_punctuality = $remark_attendance_punctuality;
}
$html .='<tr>';
$html .='<td class="td-bg brd-r">12</td>';
$html .='<td  class="td-bg brd-r">Attendance</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$attendance_punctuality.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$job_performance = "NA";
if (trim($remark_job_performance) !='did_not_comment') {
   $job_performance = $remark_attendance_punctuality;
}
$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">13</td>';
$html .='<td  class="td-bg brd-r">Job Performance</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$job_performance.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">14</td>';
$html .='<td  class="td-bg brd-r">Exit formalities</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_exit_status.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">15</td>';
$html .='<td  class="td-bg brd-r">Disciplinary issues</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_disciplinary_issues.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">16</td>';
$html .='<td  class="td-bg brd-r">Verified Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['current_employment']['verified_date']).'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"></td>';
$html .='</tr>';
/**/
$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">17</td>'; 
$html .='<td  class="td-bg brd-r">Verification Remarks</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verification_remarks.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Type Of Qualification</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$type_of_degree_edu.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$type_of_degree_img.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Major</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$edu_major.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">3</td>';
$html .='<td  class="td-bg brd-r">University / Board</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$university_board_edu.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$university_img.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">4</td>';
$html .='<td  class="td-bg brd-r">School / College</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$college_school_edu.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$college_school_img.'</td>';
$html .='</tr>';
 
$html .='<tr>';
$html .='<td class="td-bg brd-r">5</td>';
$html .='<td  class="td-bg brd-r">Year Of Passing</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_year($end).'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr> ';
$html .='<tr>';
$html .='<td class="td-bg brd-r">6</td>';
$html .='<td  class="td-bg brd-r">Course Type</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$course.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr> ';
$html .='<tr>';
$html .='<td class="td-bg brd-r">7</td>';
$html .='<td  class="td-bg brd-r">Roll Number</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$roll.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$roll_img.'</td>';
$html .='</tr>  '; 
  
$html .='<tr>';
$html .='<td class="td-bg brd-r">8</td>';
$html .='<td  class="td-bg brd-r">Verifier\'s Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$vname.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>  '; 
  
$html .='<tr>';
$html .='<td class="td-bg brd-r">9</td>';
$html .='<td  class="td-bg brd-r">Verifier\'s Designation</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verifier_designation.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>  '; 
...
$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">11</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verification_remarks.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>  '; 
...
if (strtolower($relationship) != strtolower($remark_relationship)) {
    ...
    if (strlen($remark_relationship) <= 5) {
    }
        $relationship_img = '&nbsp;&nbsp;&nbsp;&nbsp;'.$relationship_img;
}


if (strtolower($property_type) !='self') {
   $property_type = 'house with '.$property_type;
}

if (strtolower($staying_with) !='self') {
    $staying_with = 'her / his '.$staying_with;
}
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Flat / Door No</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$flat_no.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Street / Road</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$street.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">3</td>';
$html .='<td  class="td-bg brd-r">Area</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$area.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
 
$html .='<tr>';
$html .='<td class="td-bg brd-r">4</td>';
$html .='<td  class="td-bg brd-r">City / Town</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$city.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$city_img.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">5</td>';
$html .='<td  class="td-bg brd-r">Pin Code</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$pin_code.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$pin_code_img.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">6</td>';
$html .='<td  class="td-bg brd-r">State</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$state.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$state_img.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">7</td>';
$html .='<td  class="td-bg brd-r">Nearest Landmark</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$nearest_landmark.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">8</td>';
$html .='<td  class="td-bg brd-r">Duration Of Stay</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$period_of_stay.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">9</td>';
$html .='<td  class="td-bg brd-r">Property Type</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$property_type.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">10</td>';
$html .='<td  class="td-bg brd-r">Staying with</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$staying_with.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">11</td>';
$html .='<td  class="td-bg brd-r">Address Remarks</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remarks_address.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">12</td>';
$html .='<td  class="td-bg brd-r">Verifier\'s Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verifier_name.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"></td>';
$html .='</tr>';


$html .='<tr>';
$html .='<td class="td-bg brd-r">13</td>';
$html .='<td  class="td-bg brd-r">Verifier\'s Relationship</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_relationship.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">14</td>';
$html .='<td  class="td-bg brd-r">Verified Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['present_address']['verified_date']).'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"></td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">15</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verification_remarks.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<div class="container-fluid margin-1 bg-gray">
            ...
            <table class="table-2" cellspacing="0">
                <tr>
                    <th class="sr-no brd-r">#</th>
                    <th class="brd-r">Particulars</th>
                    <th colspan="2" class="brd-r">Details</th> 
                    <th>Result</th>
                </tr>';
...
$html .='<td class="td-bg brd-r">14</td>';
$html .='<td  class="td-bg brd-r">Verified Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['permanent_address']['verified_date']).'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$check16px = '<img class="tick-mark-img" src="data:image/' . $tick_mark_img_type . ';base64,' . base64_encode($tick_mark_img_data).'" />';
 ...
 $remark_date_of_relieving = json_decode($table['previous_employment']['remark_date_of_relieving'],true);
 $remark_reason_for_leaving = json_decode($table['previous_employment']['remark_reason_for_leaving'],true);
 //isset($table['current_employment']['remark_date_of_relieving'])?$table['current_employment']['remark_date_of_relieving']:'-'; 
...
$html .='<td class="td-bg brd-r">5</td>';
$html .='<td  class="td-bg brd-r">Currency Of Salary</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_currencys.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">7</td>';
$html .='<td  class="td-bg brd-r">Reason For Leaving</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_reason_for_leavings.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">8</td>';
...
$html .='<td class="td-bg brd-r">9</td>';
$html .='<td  class="td-bg brd-r">Reporting Manager Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_hr_names.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>'; 
$html .='<tr>';
$html .='<td class="td-bg brd-r">10</td>';
$html .='<td  class="td-bg brd-r">Reporting Manager Designation</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remarks_designations.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
/**/
$html .='<tr>';
$html .='<td class="td-bg brd-r">17</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks</td>';
$html .='<td colspan="2" class="td-bg brd-r brdr-r">'.$verification_remark.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Verifier Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$names.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Company Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$company_names.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td class="td-bg brd-r">3</td>';
$html .='<td  class="td-bg brd-r">Designation</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$designations.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">5</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verification_remark.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
if (strtolower($relationship) != strtolower($remark_relationships)) {
    ...
    if (strlen($remark_relationships) <= 5) {
        $relationship_img = '&nbsp;&nbsp;&nbsp;&nbsp;'.$relationship_img;
    }
}


if (strtolower($property_types) !='self') {
   $property_types = 'house with '.$property_types;
}

if (strtolower($staying_withs) !='self') {
    $staying_withs = 'her / his '.$staying_withs;
}
...
$html .='<td class="td-bg brd-r">8</td>';
$html .='<td  class="td-bg brd-r">Duration Of Stay</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$period_of_stays.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">9</td>';
$html .='<td  class="td-bg brd-r">Property Type</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$property_types.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">10</td>';
$html .='<td  class="td-bg brd-r">Staying with</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$staying_withs.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">11</td>';
$html .='<td  class="td-bg brd-r">Address Remarks</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remarks_addresss.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"> </td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">12</td>';
$html .='<td  class="td-bg brd-r">Verifier\'s Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verifier_names.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"> </td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">13</td>';
$html .='<td  class="td-bg brd-r">Verifier\'s Relationship</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_relationships.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"> </td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Country</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_countrys.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">License Number</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$licence_number.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Verified Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($dl_date).'</td>';
$html .='<td style="color: '.$color_code.'; " class="td-bg brd-r"></td>';
$html .='</tr>';
// 
$html .='<tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Credit Number</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$credit_numbers.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Document Type</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$document_types.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">4</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verification_remark.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Document Number</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$bankruptcy_numbers.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$full_name.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Contact Number</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$contect_number.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">3</td>';
$html .='<td  class="td-bg brd-r">Address</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$address.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">4</td>';
$html .='<td  class="td-bg brd-r">Education Details</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$education_detail.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
// 
$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">6</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$verification_remark.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
if (isset($table['health_checkup']['health_checkup_id'])) {
    ...
    // $candidate_name = $candidate_client_details['candidateData']['first_name'].' '.$candidate_client_details['candidateData']['last_name']; 
...
$html .='<div class="container-fluid margin-1 bg-gray">
            ...
            <table class="table-2" cellspacing="0">
                <tr>
                    ...
                    <th class="td-bg brd-r">Particulars</th>
                    <th colspan="2" class="td-bg brd-r">Details</th> 
                    <th class="td-bg brd-r">Result</th>
                </tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Candidate Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$candidate_name.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Company List</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$company_list.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">3</td>';
$html .='<td  class="td-bg brd-r">Start Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$start_date.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">4</td>';
$html .='<td  class="td-bg brd-r">End Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$end_date.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>';
$html .='<td  class="td-bg brd-r">Landlord Name</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$landload.'</td>'; 
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">2</td>';
$html .='<td  class="td-bg brd-r">Landlord Contact Number</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$number.'</td>'; 
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">3</td>';
$html .='<td  class="td-bg brd-r">How long was the tenancy?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$tenancy_perio.'</td>'; 
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">4</td>';
$html .='<td  class="td-bg brd-r">What was the Monthly rental amount?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$monthly_rental_amoun.'</td>'; 
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">5</td>';
$html .='<td  class="td-bg brd-r">Who were the occupants of the property ?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$occupants_propert.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">6</td>';
$html .='<td  class="td-bg brd-r">Did the tenant consistently pay rent on time?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$tenant_consistently_pay_rent_on_tim.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">7</td>';
$html .='<td  class="td-bg brd-r">Was the utility bills paid on time?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$utility_bills_paid_on_tim.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">8</td>';
$html .='<td  class="td-bg brd-r">Did the tenant maintain the rental property well?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$rental_propert.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">9</td>';
$html .='<td  class="td-bg brd-r">Were there any major damages or maintenance issues?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$maintenance_issue.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">10</td>';
$html .='<td  class="td-bg brd-r">Why did the tenant leave?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$tenant_leav.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">11</td>';
$html .='<td  class="td-bg brd-r">Would you rent to this tenant again?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$tenant_rent_agai.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';


$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">12</td>';
$html .='<td  class="td-bg brd-r">Did the tenant have any pets?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$tenant_pets.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">13</td>';
$html .='<td  class="td-bg brd-r">Were there any complaints from neighbors or other tenants?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$complaints_from_neighbor.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">14</td>';
$html .='<td  class="td-bg brd-r">What was the food preference of the Tenant?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$food_preferenc.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">15</td>';
$html .='<td  class="td-bg brd-r">How did the tenant spend their spare time?</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$spare_tim.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="td-bg brd-r">16</td>';
$html .='<td  class="td-bg brd-r">Describe the tenant’s overall character</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$overall_characte.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">17</td>';
$html .='<td  class="td-bg brd-r">Verified Date</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($verified_date).'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r"></td>';
$html .='</tr>';
 
$html .='<tr>';
$html .='<td class="td-bg brd-r brdr-r">18</td>';
$html .='<td  class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2"  class="td-bg brd-r">'.$remark.'</td>'; 
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<td   class="td-bg brd-r">'.$Address_title_name.'</td>';
$html .='<td  colspan="2" class="td-bg brd-r">'.$address_sub.'</td>';
$html .='<td  style="color: '.$color_code.'; "  class="td-bg brd-r">'.$address_img.'</td>';
$html .='</tr>';
...
$html .='<div class="container-fluid margin-1 bg-gray">
           ...
           $html .='<tr><td class="td-bg brd-r">1.</td>';
            $html .='<td class="td-bg brd-r">Passport/Aadhar/Voter id/SSN</td>';
            $html .='<td width="40%;" class="td-bg brd-r">'.$document_numbers.'</td>'; 
            $html .='<td class="td-bg brd-r">'.$check16px.'</td>';
            $html .='</tr>';
 
            $html .='<tr><td class="td-bg brd-r">2.</td>';
            $html .='<td class="td-bg brd-r">Verified Date</td>';
            $html .='<td width="40%;" class="td-bg brd-r">'.get_date($verified_dates).'</td>'; 
            $html .='<td style="color: '.$color_code.'; " class="td-bg brd-r"></td>';
            $html .='</tr>';

            $html .='<tr><td class="td-bg brd-r brdr-r">3.</td>';
            $html .='<td class="td-bg brd-r">Verification Remarks </td>';
            $html .='<td width="40%;" class="td-bg brd-r">'. $remarks.'</td>'; 
            $html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r border-r"></td>';
            $html .='</tr>';
...
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['sex_offender']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['sex_offender']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['politically_exposed']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['politically_exposed']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['india_civil_litigation']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['india_civil_litigation']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">MCA</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['mca']['organization_name']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">2</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['mca']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">3</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['mca']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">NRIC Number</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['nric']['nric_number']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['nric']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['nric']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['gsa']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['gsa']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r">1</td>'; 
$html .='<td  class="td-bg brd-r">Verified Date</td>'; 
$html .='<td colspan="2" class="td-bg brd-r">'.get_date($table['oig']['verified_date']).'</td>'; 
$html .='<td  class="td-bg brd-r"></td>';
$html .='</tr>';
...
$html .='<td class="td-bg brd-r brdr-r">2</td>'; 
$html .='<td   class="td-bg brd-r">Verification Remarks </td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$table['oig']['verification_remarks'].'</td>';
$html .='<td  class="td-bg brd-r border-r"></td>';
$html .='</tr>';
...
// $file_name = $generate_pdf_details_variable['invoice_pdf_name']; 
 ...
 $candidate_report = array(
    'candidate_final_report'=>$file_name_final.$time.".pdf",
    'report_generated'=>'(report_generated+1)',
 );

 $this->db->where('candidate_id',$candidate_details['candidate_id'])->update('candidate',$candidate_report);
 
$generated_pdf = file_put_contents('../uploads/bgv-report/'.$file_name_final.$time.".pdf", $output);
$pdf->stream($file_name_final.$time.".pdf", array("Attachment" => false));
$pdf->stream($file_name_final.$time.".pdf");
