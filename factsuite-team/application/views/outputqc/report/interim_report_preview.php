    ...
    <div style="padding: 35px 35px 45px 35px; background-color: #e2e5f3;margin-top: 5px; margin-right:80px; margin-left: 80px; " >
        ...
        width: 100%;">
            <tr>
                ...
                <td style="padding-bottom: 15px;">:</td>
                <td style="padding-bottom: 15px; font-weight: bold; font-size: 20px; color: #381653;">In-Progress</td>
            </tr>
        </table>
        <table style="margin-top: 25px; color: #ffffff;
        border-collapse: collapse;
        width: 100%;">
            ...
            <tbody style="padding: 10px; margin-top: 10px; background-color: #D2D4D1;">
                ...
                ?>
            <tr>
                <td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 18px;"><?php echo $value['component_name'].' - ( form '.$value['formNumber'].')'; ?></td>
...
$approved_doc = json_decode(',', $table['previous_address']['approved_doc']);
if (count($approved_doc) > 0) {
    /*$url = base_url()."../uploads/all-marksheet-docs/".$value;
    $ext = pathinfo($value, PATHINFO_EXTENSION);
    if('jpg' == $ext ||'jpeg' == $ext|| 'png' == $ext){ */
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Credit / Cibil Check</div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Bankruptcy</div>';
...
if (isset($table['cv_check']['cv_id'])) {
 ...
 /*SELECT `cv_id`, `candidate_id`, `full_name`, `contect_number`, `address`, `education_detail`, `employment_duration`, `designation_held`, `complete_employment_info`, `cv_number`, `cv_doc`, `analyst_status`, `status`, `output_status`, `assigned_role`, `assigned_team_id`, `created_date`, `updated_date`, `insuff_status`, `insuff_team_role`, `insuff_team_id`, `approved_doc`, `check_form`, `remark_country`, `assign_to`, `in_progress_remarks`, `insuff_remarks`, `Insuff_closure_remarks`, `verification_remarks`, `remarks_updateed_by_role`, `remarks_updateed_by_id`, `ouputqc_comment` FROM `cv_check` WHERE 1*/
    ...
    $verification_remarks = $table['cv_check']['verification_remarks'];
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> CV Check</div>';
...
/*SELECT `licence_id`, `candidate_id`, `licence_number`, `licence_doc`, `analyst_status`, `status`, `output_status`, `assigned_role`, `assigned_team_id`, `created_date`, `updated_date`, `insuff_status`, `approved_doc`, `check_form`, `remark_country`, `assign_to`, `in_progress_remarks`, `insuff_remarks`, `Insuff_closure_remarks`, `verification_remarks`, `remarks_updateed_by_id`, `remarks_updateed_by_role`, `insuff_team_role`, `insuff_team_id`, `ouputqc_comment` FROM `driving_licence` WHERE 1*/
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Driving License</div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Directorship Check</div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Global Sanctions/ AML</div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Adverse Media/Media Database</div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Employement Gap check</div>';
