...
<td style="padding-bottom: 15px;" width="2%">:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%">'.$employee.'</td>
...
$doc_display .='<tr>';
$doc_display .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">SSN Card Number</td>';
