...
<body>
    ...
    <main>
       ...
       <div class="container-fluid bg-gray">
            ...
            <tr>
                <td class="tbl-tx1 brd-r">Date of Joining</td>
                <td class="tbl-tx3 ">'.get_date($candidate[0]['candidaetData']['date_of_joining']).'</td>
                <td class="tbl-tx1 brd-b brd-r">Completed Date</td>
...
$html .='<div class="container-fluid margin-1 bg-gray">
      ...
      <tr>
        <td class="tbl-tx2 brd-r">Employee ID</td>
        <td class="tbl-tx3 brd-r">'.$employee.'</td>
        <td class="tbl-tx1 brd-r">Father\'s Name</td>
...
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_attendance_punctuality.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<td colspan="2" class="td-bg brd-r">'.$remark_job_performance.'</td>';
...
$html .='<td  class="td-bg brd-r">Duration Of Stay</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$start_end.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$period_of_stay.'</td>';
$html .='</tr>';
...
$html .='<td  class="td-bg brd-r">Duration Of Stay</td>';
$html .='<td colspan="2" class="td-bg brd-r">'.$start_end.'</td>';
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$period_of_stays.'</td>';
$html .='</tr>';
