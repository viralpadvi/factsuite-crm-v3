          ...
          <table class="datatable table table-striped">
                ...
                <?php  
                  if (count($case) > 0 ) {
                    foreach ($case as $key => $value) { 
                     $array = array(2);
                     if (in_array($value['candidate']['is_submitted'], $array)) { 
                         $status = '';
                         $classStatus = '';
                         $fontAwsom='';
            ...
            <tr id="tr_<?php echo $value['candidate']['candidate_id']; ?>">   
             ...
             <td id="email_id<?php echo $value['candidate']['candidate_id']; ?>"><?php echo $value['candidate']['email_id']; ?></td> 
                ...
                <td id="email_id<?php echo $value['candidate']['tat_start_date']; ?>"><?php echo $value['candidate']['tat_start_date']; ?></td> 
                  <td id="email_id<?php echo $value['candidate']['candidate_id']; ?>"><?php echo $value['candidate']['tat_end_date']; ?></td>  
                  <td id="email_id<?php echo $value['candidate']['candidate_id']; ?>"><?php echo $value['left_tat_days']; ?></td> 

               <td class="text-center"><a href="<?php echo $this->config->item('my_base_url'); ?>factsuite-outputqc/assigned-view-case-detail/<?php echo $value['candidate']['candidate_id'].'?v='.base64_encode(1); ?>" ><i class="fa fa-eye"></i></a></div></td>
           </tr> 
                       <?php 
                    }
                    }
