  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Covid-19 Check Detail</h3>
          ...
          <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                 ...
                 <input type="hidden" name="covid_id" value="<?php echo $componentData['covid_id']; ?>" id="covid_id">
                  ...
                  <?php 
                    ...
                    <h3 class="permt mt-4">Covid-19 Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <!-- Country List -->
                          <div class="row">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control verification_remarks" value="<?php echo isset($verification_remarks[$index]['verification_remarks'])?$verification_remarks[$index]['verification_remarks']:''; ?>" onkeyup="valid_verification_remarks(<?php echo $j; ?>)" onblur="valid_verification_remarks(<?php echo $j; ?>)" id="verification_remarks<?php echo $j; ?>" type="text">
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/covid_19.js"></script> 
