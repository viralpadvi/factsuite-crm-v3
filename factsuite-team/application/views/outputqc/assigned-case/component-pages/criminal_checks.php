            ...
            <div class="row mt-4">
             <div class="col-md-2 lft-p-det">
              ...
              <div class="col-md-2 ryt-p pl-0 lft-p-det">
                ...
                <?php 
                  // echo $componentData['document_uploaded_by'];
                  // exit;
                  if($componentData['document_uploaded_by'] != 'candidate'){
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/remark-criminal-check.js"></script> 
