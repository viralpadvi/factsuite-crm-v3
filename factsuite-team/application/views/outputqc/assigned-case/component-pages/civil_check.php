  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Civil Check Detail</h3>
          <hr>
                        ...
                        <div class="col-md-6">
                         ...
                         <div class="row mt2">
                            ...
                            <div class="add-vendor-bx2 d-none">
                                ...
                                <ul>
                                 <li class="vendor-wdt2">
                                    ...
                                    <div class="form-group mb-0 ">
                                      <input type="file" class="client-documents" id="client-documents<?php echo $i; ?>" name="civil-documents[]" multiple="multiple">
                                      <label class="btn upload-btn" for="client-documents<?php echo $i; ?>">Upload</label>
                                    </div>
                                      <div id="civil-upoad-docs-error-msg-div<?php echo $i; ?>">
                                        <?php
                                          $pan_card_doc = '';
                              ...
                              <div class="row" id="selected-civil-docs-li<?php echo $i; ?>"></div>
                           </div>
                          </div>
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/remark-civil-check.js"></script> 
