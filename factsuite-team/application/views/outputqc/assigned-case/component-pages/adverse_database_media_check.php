  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Adverse Database/Media Check Detail</h3>
                               ...
                               $pan_card_doc = '';
                                 ...
                                 if (!in_array('no-file',  $approved_doc[$i])) {
                                   foreach ($approved_doc[$i] as $key1 => $value) {
                                    if ($value !='') {
                                     echo "<div><span>{$value}<a onclick='exist_view_image(\"{$value}\",\"remarks-docs\")' >  <i class='fa fa-eye'></i></a></span></div>";
                  ...
                  <div class="row mt-2">
                    ...
                    <div class="col-md-6 text-right">
                      ...
                      <!-- <button id="add-court-record" class="update-bt">Update</button> -->
                       <button class="update-bt" id="show-confirmation-dialog">Update</button> 
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/adverse_database_media_check.js"></script> 
