  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Credit/Cibil Check Details </h3>
                          ...
                          <div class="row mt-2">
                             <div class="col-md-2 lft-p-det">
                              ...
                              <div class="col-md-4 ryt-p pl-0">
                                 <p><?php echo isset($document_type[$index]['document_type'])?$document_type[$index]['document_type']:'Not found';?></p>
                                 <p><?php echo isset($credit_number[$index]['credit_cibil_number'])?$credit_number[$index]['credit_cibil_number']:'Not Found';?></p>
                                              ...
                                              foreach ($approved_doc[$index] as $key1 => $value) {
                                                if ($value !='') {
                                                   $url = base_url()."../uploads/remarks-docs/".$value;
                                                    echo "<div class='image-selected-div'><span>{$value}</span><a onclick='view_document_modal(\"{$url}\")' >  <i class='fa fa-eye'></i></a> <a href='{$url}' download >  <i class='fa fa-download'></i></a></div>";     
                                                }
                                              }
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/credit_cibil.js"></script> 
