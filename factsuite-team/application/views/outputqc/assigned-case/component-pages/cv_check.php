  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">CV Check Detail</h3>
                              ...
                              <div class="image-selected-div">
                                <ul class="p-0 mb-0">
                                  ...
                                  <li class="image-name-delete pb-0">
                                    <a id="docs_modal_file<?php echo $candidateId ?>" onclick="view_document_modal(<?php echo "'".$url."'" ?>,'cv-docs')"
                    ...
                    <h3 class="permt mt-4">CV Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          ...
                          <div class="row mt-2">
                           ...
                           <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <select class="fld form-control candidate_full_name"
                                id="candidate_full_name">
                                  <option <?php echo $full_name_did_not_comment ?> value="did_not_provide">Did Not Provide</option>
                        ...
                        <div class="col-md-6">
                          <div class="row mt-2">
                              <div class="col-md-3">
                                <p class="det">Contact Number</p>
                              </div>
                              <div class="col-md-2 pr-0">
                                <p>:</p>
                              </div>
                              <div class="col-md-7">
                                <select class="fld form-control contact_number"
                                  id="contact_number">
                                    <option <?php echo  $contect_number_did_not_comment?> value="did_not_provide">Did Not Provide</option>
                                    <option <?php echo $contect_number_match ?> value="match">Match</option>
                                    <option <?php echo $contect_number_mismatch ?> value="mismatch">Mismatch</option>
                                  </select>
                          ...
                          <div class="row mt-2">
                              ...
                              <div class="col-md-7">
                                <select class="fld form-control candidate_address"
                                  id="candidate_address">
                                    <option <?php echo $candidate_address_did_not_comment ?> value="did_not_provide">Did Not Provide</option>
                                    <option <?php echo $candidate_address_match ?> value="match">Match</option>
                                    <option <?php echo $candidate_address_mismatch ?> value="mismatch">Mismatch</option>
                                  </select>
                          ...
                          <div class="row mt-2">
                              ...
                              <div class="col-md-7">
                                <select class="fld form-control education_details"
                                  id="education_details">
                                    <option <?php echo $education_detail_did_not_comment ?> value="did_not_provide">Did Not Provide</option>
                                    <option <?php echo $education_detail_match ?> value="match">Match</option>
                                    <option <?php echo $education_detail_mismatch ?> value="mismatch">Mismatch</option>
                                  </select>
                          ...
                          <div class="row mt-2">
                              ...
                              <div class="col-md-7">
                                <select class="fld form-control employement_duration"
                                  id="employement_duration">
                                    <option <?php echo $employment_duration_did_not_comment ?> value="did_not_provide">Did Not Provide</option>
                                    <option <?php echo $employment_duration_match ?> value="match">Match</option>
                                    <option <?php echo $employment_duration_mismatch ?> value="mismatch">Mismatch</option>
                                  </select>
                          ...
                          <div class="row mt-2">
                                ...
                                <div class="col-md-7">
                                  <select class="fld form-control designation_held"
                                    id="designation_held">
                                      <option <?php echo  $designation_held_did_not_comment?> value="did_not_provide">Did Not Provide</option>
                                      <option <?php echo $designation_held_match  ?> value="match">Match</option>
                                      <option <?php echo $designation_held_mismatch ?> value="mismatch">Mismatch</option>
                                    </select>
                          ...
                          <div class="row mt-2">
                                ...
                                <div class="col-md-7">
                                  <select class="fld form-control complete_emp_info"
                                    id="complete_emp_info">
                                      <option <?php echo $complete_emp_info_did_not_comment?> value="did_not_provide">Did Not Provide</option>
                                      <option <?php echo $complete_emp_info_match ?> value="match">Match</option>
                                      <option <?php echo $complete_emp_info_mismatch ?> value="mismatch">Mismatch</option>
                                    </select>
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/cv_check.js"></script> 
