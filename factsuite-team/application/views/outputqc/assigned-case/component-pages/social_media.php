            ...
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <?php 
                    ...
                    <h3 class="permt mt-4">Gloal Databse Details Verification Details </h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                            <div class="col-md-3">
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/remark-social-media.js"></script>