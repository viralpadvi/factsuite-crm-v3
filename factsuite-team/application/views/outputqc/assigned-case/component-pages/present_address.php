  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Present Address Check Detail</h3>
          <hr>
            ...
            <div class="container">
                <div class="detail mb-5">
                  <div class="row hd">
                    ...
                    <div>
                      <h3 class="permt mt-4">Present Address Details</h3>
                       <div class="row mt-3"> 
                          <div class="col-md-2 lft-p-det">
                            <p>House/Flat No</p>
                            <p>Street/Road</p>
                         ...
                         <div class="col-md-3 ryt-p pl-0">
                            ...
                            <p><?php echo isset($componentData['contact_person_mobile_number'])?$componentData['contact_person_mobile_number']:'value not found'?></p> 
                         </div>
                          <div class="col-md-2 lft-p-det">
                            <p>Pin Code</p>
...
gov_utility_bill -->
                    ...
                    <h3 class="permt mt-4">Present Address  verification Details</h3>
                     <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                            <div class="col-md-3">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control present_address_id" value="<?php echo isset($componentData['present_address_id'])?$componentData['present_address_id']:''; ?>" id="present_address_id" type="hidden">
                              <textarea class="fld form-control address" rows="4" id="address" spellcheck="false"><?php echo isset($componentData['remarks_address'])?$componentData['remarks_address']:''; ?></textarea>
                            ...
                            <div class="col-md-7">
                              ...
                              <select  class="fld form-control country select2 state" id="state" onchange="getCitySingle(this.id)">
                                <option>Select State</option>
                                  <?php 
                                    $get_state = isset($componentData['remarks_state'])?$componentData['remarks_state']:'Karnataka';
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control pincode" value="<?php echo isset($componentData['remarks_pincode'])?$componentData['remarks_pincode']:''; ?>" oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')" id="pincode" type="text">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              ...
                              <?php 
                                ...
                                $Friends = '';
                                $Alone = '';
                                $staying_with = isset($componentData['staying_with'])?$componentData['staying_with']:'';
                                if($staying_with == 'Family'){
                                  $Family = 'selected';
                                }else if($staying_with == 'Friends'){
                                  $Friends = 'selected';
                                }else if($staying_with == 'Alone'){
                                  $Alone = 'selected';
                                }
                              ?>
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control verifier_name" value="<?php echo isset($componentData['verifier_name'])?$componentData['verifier_name']:''; ?>" id="verifier_name" type="text">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control progress_remarks" value="<?php echo isset($componentData['progress_remarks'])?$componentData['progress_remarks']:''; ?>" id="progress_remarks" type="text">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control infuff_remarks" value="<?php echo isset($componentData['insuff_remarks'])?$componentData['insuff_remarks']:''; ?>" id="infuff_remarks" type="text">
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control period_of_stay" value="<?php echo isset($componentData['period_of_stay'])?$componentData['period_of_stay']:''; ?>" id="period_of_stay" type="text">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control initiated_date mdate" value="<?php echo isset($componentData['initiated_date'])?$componentData['initiated_date']:''; ?>" id="initiated_date" readonly type="text">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control closure_date mdate" readonly value="<?php echo isset($componentData['closure_date'])?$componentData['closure_date']:''; ?>" id="closure_date" type="text">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control assigned_to_vendor" value="<?php echo isset($componentData['assigned_to_vendor'])?$componentData['assigned_to_vendor']:''; ?>" id="assigned_to_vendor" type="text">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              ...
                              <?php 
                                ...
                                $Owned = '';
                                $others = '';
                                $property_type = isset($componentData['property_type'])?$componentData['property_type']:'';
                                if($property_type == 'Rented'){
                                  $Rented = 'selected';
                                }else if($property_type == 'Owned'){
                                  $Owned = 'selected';
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                               <textarea class="fld form-control closure_remarks" id="closure_remarks"><?php echo $componentData['closure_remarks']; ?></textarea>
                ...
                <hr>
                  <div class="row mt-2">
                    ...
                    <div class="col-md-6 text-right">
                      ...
                      <!-- <button id="submit-present-address" class="update-bt">Update</button> -->
          ...
          <div class="modal-pending-bx">
            ...
            <!--  <textarea class="message">Message...</textarea>
             <div class="form-group w-100 mt-2">
                ...
                <button class="btn bg-blu float-right text-white" id="submit-present-address">Confirm</button>
             <div class="clr"></div>
          </div>
       </div>
    </div>
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/remark-present-address.js"></script>
