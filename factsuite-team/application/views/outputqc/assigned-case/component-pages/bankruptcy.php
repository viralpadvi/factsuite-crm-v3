  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Bankruptcy Checke Detail </h3>
                ...
                <div class="detail mb-5">
                 ...
                 <input type="hidden" name="bankruptcy_id" value="<?php echo $componentData['bankruptcy_id']; ?>" id="bankruptcy_id">
                  ...
                  <?php 
                    ...
                    // echo "<br>";
                    // count($bankruptcy_number)
                    
                    for ($i=0; $i < count($bankruptcy_number) ; $i++) { 
                        $index = $i;
                      // print_r($analyst_status[$i]);
                      // echo "<br>";
                    ...
                    <!--   -->
                    <!-- <div> -->
                      <h3 class="permt mt-4">Bankruptcy Check Form (<?php echo $j?>)</h3> 
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                             <div class="col-md-2 lft-p-det">
                              ...
                              <div class="col-md-4 ryt-p pl-0">
                                 ...
                                 <p><?php echo isset($bankruptcy_number[$index]['bankruptcy_number'])?$bankruptcy_number[$index]['bankruptcy_number']:'Not Found';?></p>
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/bankruptcy.js"></script> 
