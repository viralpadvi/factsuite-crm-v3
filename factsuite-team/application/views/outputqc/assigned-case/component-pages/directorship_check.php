  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-admin">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Directorship Check Detail</h3>
                    ...
                    <hr>
                     ...
                     <div class="row mt2">
                            <div class="col-md-6">
                              ...
                              <span><?php echo  $analystStatus; ?></span>
                              <input type="hidden" 
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/directorship-check.js"></script> 
