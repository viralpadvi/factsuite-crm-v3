                 ...
                 <input type="hidden" name="court_records_id" value="<?php echo $componentData['court_records_id']; ?>" id="court_records_id">
                  <?php 
                    ...
                    // echo "<br>address:".count($address);  
                     $address_proof_doc= json_decode($componentData['address_proof_doc'],true);
                        ...
                        <?php
                               // $rental_agreement = '';
                                 ...
                                 if (!in_array('no-file',explode(',', $address_proof_doc[$i]))) {
                                   foreach (explode(',', $address_proof_doc[$i]) as $key1 => $value) {
                                      if ($value !='') {
                      ...
                      <div class="row mt-3"> 
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <!-- <?php //echo $componentData['insuff_remarks']."<br>"; ?> --> 
                              <textarea class="fld form-control insuff_remarks" onkeyup="valid_insuff_remarks(<?php echo $j; ?>)" onblur="valid_insuff_remarks(<?php echo $j; ?>)" id="insuff_remarks<?php echo $j; ?>"><?php echo isset($insuff_remarks[$i]['insuff_remarks'])?$insuff_remarks[$i]['insuff_remarks']:''; ?></textarea>
...
<script src="<?php echo base_url() ?>assets/custom-js/outputqc/remarks/remark-court-record.js"></script> 
