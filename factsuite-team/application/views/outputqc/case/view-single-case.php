  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt">
         <h3>Case Detail</h3>
          ...
          <a href="<?php echo $this->config->item('my_base_url')?>factsuite-inputqc/view-all-case-list/" > Back </a>
...
<script src="<?php echo base_url() ?>assets/custom-js/inputqc/case/view-single-case.js"></script>
<script>
