        ...
        <div class="add-client-bx">
           ...
           <ul>
              ...
              <li>
                 ...
                 <input type="number" class="form-control fld" id="phone_number" required="">
              ...
              <li>
                ...
                <input type="text" class="fld form-control date-min-today" id="date_of_joining" name="date_of_joining" >
