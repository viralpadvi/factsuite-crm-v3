...
<!-- plug -->
  ...
  <link href="https://fonts.googleapis.com/css2?family=Rubik:wght@300;400;500;600;700&display=swap" rel="stylesheet">
     ...
     <title>Fact Suite - OutPutQc</title>
</head>
<body>
<!--Header-->
<!-- <header>
            ...
            <div class="hdr-mn">
               <ul>
                  <li class="nav-item dropdown ml-1" title="Internal Chat">
                     <a class="nav-link" href="<?php echo $this->config->item('my_base_url')?>factsuite-outputqc/internal-chat">
                  ...
                  <li>
                     <a href="#" class="candate"><span></span><?php echo $userData['first_name']?></a>
                  </li>
                  <li>
...
<script>
  ...
  var team_id = "<?php echo $userData['team_id']?>"
   ...
   function get_ticket_notifications() {
      $.ajax({
         type: 'post',
         url: base_url+'factsuite-outputqc/get-ticket-notifications',
         data: {
         ...
         success: function(data) {
            ...
            if (data.all_ticket_notifications.length > 0) {
               ...
               for (var i = 0; i < data.all_ticket_notifications.length; i++) {
                  html += '<a href="'+base_url+'factsuite-outputqc/tickets-assigned-to-me?tkt_id='+all_ticket_notifications[i].ticket_id+'" class="dropdown-item"><i class="fa fa-id-card-o noti-icon-color mr-2"></i>';
