  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt">
         <!-- <h3>Case Detail</h3> -->
          ...
          <a class="btn bg-blu btn-submit-cancel" href="<?php echo $this->config->item('my_base_url')?>factsuite-inputqc/assigned-case-list" ><span class="text-white">Back</span></a>
          ...
          <div class="row">
            ...
            <div class="col-md-6">
             ...
             <div class="col-md-6">
              <label class="font-weight-bold">Contact Start Time :</label><span id="start_date">-</span>
            </div> 
            <div class="col-md-6">
              <label class="font-weight-bold">Contact End Time :</label><span id="end_date">-</span>
            </div> 
            <div class="col-md-12" id="form-submited"></div>
            

          </div>
          <div class="row mt-4">
           <!--  <div class="col-md-12" id="personal_docuemnts_div">
               <button id="view_personal_docuemnts" class="btn bg-blu text-white float-right">View Docuemnts</button>
            </div> -->
            
          </div>
          <div class="row mt-4">
            <div class="col-md-6 table-responsive mt-3" id="">
    ...
    <div class="modal-dialog modal-md modal-dialog-centered">
       <div class="modal-content">
          <div class="modal-pending-bx">
            ...
            <div class="mb-2">
                <label>Enter Insuff Remarks</label>
                <input type="text" placeholder="Enter remarks" name="insuff_remarks" id="insuff_remarks" class="fld form-control">
            </div>
    ...
    <div class="modal-dialog modal-lg modal-dialog-centered">
      <div class="modal-content modal-content-view-collection-category">
        <div class="modal-header border-0">
          <h3 id="" class="text-white">View Document</h4>
        </div>
...
<script src="<?php echo base_url() ?>assets/custom-js/inputqc/assigned-case/view-single-case.js?v=<?php echo date('YmdHis'); ?>"></script>
<script>
  var masked_candidate_id = '<?php echo md5($candidate_id);?>';
