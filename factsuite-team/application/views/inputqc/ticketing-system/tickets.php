...
<!-- custom-js -->
<script src="<?php echo base_url() ?>assets/custom-js/inputqc/ticketing/raise-ticket.js"></script>
<script src="<?php echo base_url() ?>assets/custom-js/inputqc/ticketing/all-tickets.js"></script>