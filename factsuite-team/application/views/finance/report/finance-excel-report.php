          ...
          <div class="payment-gst-container mt-4">
            ...
            <div class="row mt-3">
              <div class="col-md-12 mt-3">
                <span class="d-block medium-text">Type of Report</span>
                  <select class="form-control input-txt" required name="report-type" id="report-type">
                  <!-- <option selected value="">Select Duration</option> -->
                  <option value="1">General Report</option> 
                  <option value="2">Vendor Report</option> 
                  <option value="3">Re-Initiation / Re-Open Report</option> 
                  <option value="4">Ageing Report</option> 
                  <option value="5">Website Invoice Report</option> 
                </select>
              </div> 
...
<!--Content-->
<script src="<?php echo base_url();?>assets/custom-js/finance/report/excel-report.js"></script>
  <script>
