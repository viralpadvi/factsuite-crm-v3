          ...
          <table class="datatable table table-striped">
            ...
            <tr id="tr_<?php echo $value['candidate_id']; ?>">   
             ...
             <td id="email_id<?php echo $value['candidate_id']; ?>"><?php echo $value['email_id']; ?></td> 
               ...
               <td class="text-center"><a href="<?php echo $this->config->item('my_base_url'); ?>factsuite-outputqc/assigned-view-case-detail/<?php echo $value['candidate_id']; ?>" ><i class="fa fa-eye"></i></a></div></td>
           </tr> 
                       <?php 
                    }
                  }
