  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt pt-3">
        <!--Add Client Content-->
         <div class=""> 
           <a href="<?php echo $this->config->item('my_base_url')?>factsuite-finance/edit-client-component-packages/<?php echo $client_id; ?>" class="btn bg-blu btn-submit-cancel text-white"><i class="fas fa-arrow-left"></i> Back</a>
        </div>
 ...
 $thresold =  $this->packageModel->single_component_details($com['component_id']);
        ...
        <div class="row ul<?php echo $com['alacarte_id']; ?>">
          ...
          <label class="custom-control-label" for="customCheck<?php echo $com['alacarte_id'].'_'.$com['component_id']; ?>"><?php echo $com[$this->config->item('show_component_name')]; ?></label>
          </div>
          </div>
          <div class="col-md-4 mt-1">
