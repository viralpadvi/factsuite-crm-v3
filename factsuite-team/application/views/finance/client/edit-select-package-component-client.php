  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt pt-3">
        <!--Add Client Content-->
         <div class=""> 
           <a href="<?php echo $this->config->item('my_base_url')?>factsuite-finance/edit-client/<?php echo $client_id; ?>" class="btn bg-blu btn-submit-cancel text-white"><i class="fas fa-arrow-left"></i> Back</a>
        </div>
        <div class="add-client-bx">
           ...
           <div class="card">
              ...
              if (count($package) > 0) {
                ...
                <div class="float-right"><a onclick="remove_package(<?php echo $val['package_id']; ?>)"><i class="fa fa-remove"></i></a></div>
              </div>
                </div>
