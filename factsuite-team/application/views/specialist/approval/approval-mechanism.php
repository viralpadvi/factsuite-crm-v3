...
<!-- custom-js -->
<script src="<?php echo base_url() ?>assets/custom-js/specialist/approval/create-approval.js"></script>
<script src="<?php echo base_url() ?>assets/custom-js/specialist/approval/all-approvals.js"></script>