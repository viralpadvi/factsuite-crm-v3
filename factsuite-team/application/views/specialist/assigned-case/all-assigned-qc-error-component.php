        ...
        <h3>View All Components</h3>
          ...
          <table class="datatable table table-striped">
            ...
            <tbody class="tbody-datatable" id="get-case-data-1"> 
                 <?php 
                $i = 1; 
                    if (count($assign_component) > 0) {
                        foreach ($assign_component as $key => $value) {
                    ...
                    if ($value['analyst_status'] == '0' || $value['analyst_status'] == '1' || $value['analyst_status'] == '11') {
                     ...
                     $code = isset($value['candidate_detail']['country_code'])?$value['candidate_detail']['country_code']:'+91';
                            ...
                            <tr>
                                ...
                                <td><?php echo $inputQcStatus; ?></td>
                                <td><?php echo $analystQcStatus; ?></td>
                                <td><a href="<?php echo $this->config->item('my_base_url'); ?>factsuite-specialist/component-detail/<?php echo $arg; ?>" class="app-btn">View <i class="fas fa-angle-right"></i></a></td>
                            </tr>
...
<!-- <script src="<?php echo base_url() ?>assets/custom-js/specialist/assigned-case/view-all-qc-error-component.js"></script> -->
<!-- <script src="<?php echo base_url() ?>assets/custom-js/specialist/assigned-case/view-single-case.js"></script>  -->
