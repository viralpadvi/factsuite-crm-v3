            ...
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <?php 
                    ...
                    <h3 class="permt mt-4">Current Employment Verification Information</h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          	<div class="row mt-2">
  	                            <div class="col-md-3">
                          	...
                          	<div class="row mt-2">
	                            ...
	                            <div class="col-md-7">
	                              <input name="date_of_joining" class="fld form-control date-for-candidate-aggreement-start-date" id="date_of_joining" value="<?php echo $componentData['remark_date_of_joining']?$componentData['remark_date_of_joining']:""?>" type="text" data-dtp="dtp_vOoRp">
                          	...
                          	<div class="row mt-2">
	                            ...
	                            <div class="col-md-7">
	                              <input name="date_of_relieving" disabled class="fld form-control date-for-candidate-aggreement-end-date" id="date_of_relieving" value="<?php echo $componentData['remark_date_of_relieving']?$componentData['remark_date_of_relieving']:""?>" type="text" data-dtp="dtp_vOoRp">
                        ...
                        <div class="col-md-6">
                          	...
                          	<div class="row mt-2">
	                            ...
	                            <div class="col-md-7">
	                              <input name="verification_remarks" class="fld form-control pincode" id="verification_remarks" value="<?php echo $componentData['remarks_emp_id']?$componentData['remarks_emp_id']:""?>" type="text">
	                            </div>
                          	...
                          	<div class="row mt-2">
	                            ...
	                            <div class="col-md-7">
	                              <input name="insuff_remarks" class="fld form-control pincode" id="insuff_remarks" value="<?php echo $componentData['Insuff_remarks']?$componentData['Insuff_remarks']:""?>" type="text">
	                            </div>
                          	</div>
                          	<div class="row mt-2">
	                            <div class="col-md-3">
	                            ...
	                            <div class="col-md-7">
	                              <input name="insuff_closure_remarks" class="fld form-control pincode" id="insuff_closure_remarks" value="<?php echo $componentData['remarks_emp_id']?$componentData['remarks_emp_id']:""?>" type="text">
	                            </div>
                          	</div>
                            <div class="row mt-2">
                              <div class="col-md-3">
