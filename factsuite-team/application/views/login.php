...
<body>
<div class="sign-lft">
  <div class="sign-bnr"><img src="<?php echo base_url(); ?>assets/admin/images/otp-banner.png" /></div>
...
<div class="sign-rgt">
   <div class="sign-logo">
     <a href="#"><img src="<?php echo base_url(); ?>assets/admin/images/FactSuite-logo.png" /></a>
   </div>
   <div class="sign-txt">
     <h1>Sign in</h1>
   </div>
   <div class="sign-frm">
      ...
      <a class="sign-btn mr-4" target="_blank" href="https://factsuite.net/admin/">Old CRM Link</a>
      <div class="clr"></div>
   </div>
</div>
<div class="clr"></div>
