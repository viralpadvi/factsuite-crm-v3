<?php 
  ...
  $covid_19_id =  isset($componentData['covid_id'])?$componentData['covid_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $covid_19_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Covid-19 Check Form Detail (Form<?php echo $num = ($index+1) ?>)</h3>
                ...
                <div class="detail mb-5">
                 ...
                 <input type="hidden" name="covid_id" value="<?php echo $componentData['covid_id']; ?>" id="covid_id">
                  ...
                  <?php 
                    ...
                    <h3 class="permt mt-4">Covid-19 Check Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <!-- Country List -->
                          <div class="row">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/covid_19.js"></script> 
