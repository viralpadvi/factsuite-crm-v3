<?php 
  ...
  $social_id =  isset($componentData['social_id'])?$componentData['social_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" value="<?php echo $social_id ?>" id="social_id" name="social_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $social_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Social Media Form Detail</h3>
          <hr>
            ...
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <?php 
                    ...
                    <div>
	                    <h3 class="permt mt-4">Social Media Details(Candidate filled)</h3>
	                    <div class="row mt-3"> 
                          	<div class="col-md-6">
	                       		<div class="row mt-2">
	                       		...
	                       		<div class="row mt-2">
	                       			...
	                       			<div class="col-md-7 ryt-p">
	                       				<p><?php echo isset($componentData['dob'])?date($php_code_selected_datetime_format[0],strtotime($componentData['dob'])):"No data found"?></p>
	                       			</div>
	                       		</div>
                            <div class="row mt-2">
                              <div class="col-md-3 lft-p-det">
                                <p>Latest Employment Company name </p>
                              </div>
                              <div class="col-md-2 ryt-p">
                                <p>:</p>
                              </div>
                              ...
                              ?>
                              <div class="col-md-7 ryt-p">
                                <p><?php echo isset($componentData['employee_company_info'])?$componentData['employee_company_info']:"No data found"?></p>
                              </div>
                            </div>
                      <div class="row mt-2">
                              <div class="col-md-3 lft-p-det">
                                <p>Highest Education College </p>
                              </div>
                              <div class="col-md-2 ryt-p">
                                <p>:</p>
                              </div>
                              ...
                              <div class="col-md-7 ryt-p">
                                <p><?php echo isset($componentData['education_info'])?$componentData['education_info']:"No data found"?></p>
                              </div>
                            </div>
                      ...
                      <div class="row mt-2">
                              ...
                              ?>
                              <div class="col-md-7 ryt-p">
                                <p><?php echo isset($componentData['university_info'])?$componentData['university_info']:"No data found"?></p>
                              </div>
                            </div>
                          
                          <div class="row mt-2">
                              <div class="col-md-3 lft-p-det">
                                <p>Social media handles if any </p>
                              </div>
                              <div class="col-md-2 ryt-p">
                                <p>:</p>
                              </div>
                              ...
                              ?>
                              <div class="col-md-7 ryt-p">
                                <p><?php echo isset($componentData['social_media_info'])?$componentData['social_media_info']:"No data found"?></p>
                              </div>
                            </div>
                    ...
                    <h3 class="permt mt-4">Social Media Details Verification Details </h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                            <div class="col-md-3">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-social-media.js"></script>
