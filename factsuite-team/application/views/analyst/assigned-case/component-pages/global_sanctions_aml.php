<?php 
  ...
  $sanction_id = isset($componentData['global_sanctions_aml_id'])?$componentData['global_sanctions_aml_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $sanction_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt " class="FS-candidate-cnt-analyst">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Global Sanction/ AML Detail (Form<?php echo $num = ($index+1) ?>)</h3>
          ...
          <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                 ...
                 <input type="hidden" name="global_sanctions_aml_id" value="<?php echo $componentData['global_sanctions_aml_id']; ?>" id="global_sanctions_aml_id">
                  ...
                  <?php 
                    ...
                    <h3 class="permt mt-4">Global Sanction/ AML Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <!-- Country List -->
                          <div class="row">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/global_sanctions_aml.js"></script>
