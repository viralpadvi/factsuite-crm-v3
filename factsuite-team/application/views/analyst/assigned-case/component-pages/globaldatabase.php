<?php 
  ...
  $globaldatabase_id =  isset($componentData['globaldatabase_id'])?$componentData['globaldatabase_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" value="<?php echo $globaldatabase_id ?>" id="globaldatabase_id" name="globaldatabase_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $globaldatabase_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Global Database Form Detail</h3>
          <hr>
