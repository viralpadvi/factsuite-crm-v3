<?php 
  ...
  $adv_media_id =  isset($componentData['adverse_database_media_check_id'])?$componentData['adverse_database_media_check_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $adv_media_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Adverse Database/Media Form Detail (Form<?php echo $num = ($index+1) ?>)</h3>
          ...
          <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                 ...
                 <input type="hidden" name="adverse_database_media_check_id" value="<?php echo $componentData['adverse_database_media_check_id']; ?>" id="adverse_database_media_check_id">
                  ...
                  <?php 
                    ...
                    <h3 class="permt mt-4">Adverse Database/Media Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <!-- Country List -->
                          <div class="row">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <!-- <input name="" class="fld form-control verification_remarks" value=""type="text"> -->
                              <textarea  onkeyup="valid_verification_remarks(<?php echo $j; ?>)" onblur="valid_verification_remarks(<?php echo $j; ?>)" id="verification_remarks<?php echo $j; ?>"  class="form-control fld verification_remarks"><?php echo isset($verification_remarks[$index]['verification_remarks'])?$verification_remarks[$index]['verification_remarks']:''; ?></textarea>
                  ...
                  <div class="row mt-2">
                    <div class="col-md-6">
                      ...
                      <?php
                        ...
                        $disabled = '';
                        if($remarks_updateed_by_role == 'insuff analyst' && $analyst_status == 3){
                          // $disabled = 'disabled';
                        }
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/adverse_database_media_check.js"></script> 
