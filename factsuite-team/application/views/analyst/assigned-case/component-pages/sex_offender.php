<?php 
  ...
  $sex_offender_id =  isset($componentData['sex_offender_id'])?$componentData['sex_offender_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" value="<?php echo $sex_offender_id ?>" id="sex_offender_id" name="sex_offender_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $sex_offender_id;?>">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-sex-offender.js"></script>
