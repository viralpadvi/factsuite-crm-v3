<?php 
  ...
  $credit_cibil_id = isset($componentData['credit_id'])?$componentData['credit_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $credit_cibil_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Credit/Cibil Form Details </h3>
          ...
          <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                 ...
                 <input type="hidden" name="credit_id" value="<?php echo $componentData['credit_id']; ?>" id="credit_id">
                  ...
                  <?php 
                    ...
                    <!--   -->
                    <!-- <div> -->
                      <h3 class="permt mt-4">Credit/Cibil Check </h3> 
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                             <div class="col-md-2 lft-p-det">
                              ...
                              <div class="col-md-4 ryt-p pl-0">
                                 <p><?php echo isset($document_type[$index]['document_type'])?$document_type[$index]['document_type']:'';?></p>
                                 <p><?php echo isset($credit_number[$index]['credit_cibil_number'])?$credit_number[$index]['credit_cibil_number']:'';?></p>
                                 <p><?php echo isset($componentData['credit_address'])?$componentData['credit_address']:'';?></p>
                                 <p><?php echo isset($componentData['gender'])?$componentData['gender']:'';?></p>
                    ...
                    <hr> 
                    <h3 class="permt mt-4">Credit/Cibil Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <!-- Country List -->
                          <div class="row">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input 
                                name="" 
                                class="fld form-control insuff_remarks" 
                                value="<?php echo isset($insuff_remarks[$index]['insuff_remarks'])?$insuff_remarks[$index]['insuff_remarks']:''; ?>"  
                                onkeyup="valid_insuff_remarks(<?php echo $j; ?>)" 
                                onblur="valid_insuff_remarks(<?php echo $j; ?>)" 
                                id="insuff_remarks<?php echo $j; ?>" type="text">
                              ...
                              <ul>
                               ...
                               $pan_card_doc = '';
                                 ...
                                 if (!in_array('no-file',$approved_doc[$index])) {
                                   foreach ($approved_doc[$index] as $key1 => $val) {
                                      if ($val !='') {
...
?>
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/credit_cibil.js"></script> 
