<?php 
  ...
  $nric_id =  isset($componentData['nric_id'])?$componentData['nric_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" value="<?php echo $nric_id ?>" id="nric_id" name="nric_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $nric_id;?>">
                          	...
                          	<div class="col-md-6">
	                       		<div class="row mt-2">
	                       			...
	                       			<div class="col-md-7 ryt-p">
	                       				<p><?php echo isset($componentData['nric_number'])?$componentData['nric_number']:"No data found"?></p>
	                       			</div>
	                       		</div>
	                       		<div class="row mt-2">
	                       			<div class="col-md-3 lft-p-det">
	                       			...
	                       			<div class="col-md-7 ryt-p">
	                       				<p><?php echo isset($componentData['joining_date'])?$componentData['joining_date']:"No data found"?></p>
	                       			</div>
	                       		</div>
	                       		<div class="row mt-2">
	                       			<div class="col-md-3 lft-p-det">
	                       			...
	                       			<div class="col-md-7 ryt-p">
	                       				<p><?php echo isset($componentData['end_date'])?$componentData['end_date']:"No data found"?></p>
	                       			</div>
	                       		</div>
                            <div class="row mt-2">
                              <div class="col-md-3 lft-p-det">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-nric.js"></script>
