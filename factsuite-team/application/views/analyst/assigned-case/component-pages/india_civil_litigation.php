<?php 
  ...
  $india_civil_litigation_id =  isset($componentData['india_civil_litigation_id'])?$componentData['india_civil_litigation_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" value="<?php echo $india_civil_litigation_id ?>" id="india_civil_litigation_id" name="india_civil_litigation_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $india_civil_litigation_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">India Civil Litigation Form Detail</h3>
          <hr>
            ...
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <?php 
                    ...
                    <div>
	                    <h3 class="permt mt-4">India Civil Litigation(Candidate filled)</h3>
	                    <div class="row mt-3"> 
                          	<div class="col-md-6">
	                       		<div class="row mt-2">
                            ...
                            <div class="row mt-2">
                              ...
                              <div class="col-md-7 ryt-p">
                                <p><?php echo isset($componentData['address'])?$componentData['address']:"No data found"?></p>
                              </div>
                            </div>
	                       	</div> 
                      	</div>
                    </div>
                    <h3 class="permt mt-4">India Civil Litigation Verification Details </h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                            <div class="col-md-3">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-india-civil-litigation.js"></script>
