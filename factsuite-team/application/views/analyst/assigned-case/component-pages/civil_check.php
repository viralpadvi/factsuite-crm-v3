<?php 
  ...
  $candidateDob =  isset($componentData['date_of_birth'])?$componentData['date_of_birth']:"-"; 
 ...
 $candidate_address =  isset($componentData['candidate_addresss'])?$componentData['candidate_addresss']:"-";
  ...
  $civil_check_id = isset($componentData['civil_check_id'])?$componentData['civil_check_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $civil_check_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Civil Form Detail (Form<?php echo $num = ($index+1) ?>)</h3>
          <hr>
          ...
          <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <input type="hidden" name="civil_check_id" value="<?php echo $componentData['civil_check_id']; ?>" id="civil_check_id">
                  <?php 
                    ...
                    <div>
                      ...
                      <div class="row mt-3"> 
                         ...
                         <div class="col-md-4 ryt-p pl-0">
                            <p><?php echo $address[$index]['address'];?></p>
                    ...
                    <h3 class="permt mt-4">Civil Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                            <div class="col-md-3">
                         ...
                         <div class="row mt2">
                            <div class="add-vendor-bx2">
                              ...
                              <ul>
                                <li class="vendor-wdt2">
                                    ...
                                    <div class="form-group mb-0">
                                      <input type="file" class="client-documents" id="client-documents" name="civil-documents[]" multiple="multiple">
                                      <label class="btn upload-btn" for="client-documents">Upload</label>
                                    </div>
                                      <div id="civil-upoad-docs-error-msg-div">
                                        <?php
                                          $pan_card_doc = '';
                              ...
                              <div class="row" id="selected-civil-docs-li"></div>
                           </div>
                          </div>
                        </div>
                        <div class="col-md-6">
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7"> 
                              <textarea class="fld form-control insuff_remarks" onkeyup="valid_insuff_remarks(<?php echo $j; ?>)" onblur="valid_insuff_remarks(<?php echo $j; ?>)" id="insuff_remarks<?php echo $j; ?>"><?php echo isset($insuff_remarks[$index]['insuff_remarks'])?$insuff_remarks[$index]['insuff_remarks']:''; ?></textarea>
                ...
                <hr>
                  <div class="row mt-2">
                    ...
                    <div class="col-md-6 text-right">
                      ...
                      <!-- <button id="add-civil-check" class="update-bt">Update</button> -->
          ...
          <div class="modal-pending-bx">
            ...
            <!--  <textarea class="message">Message...</textarea>
             <div class="form-group w-100 mt-2">
                ...
                <button class="btn bg-blu float-right text-white" id="add-civil-check">Confirm</button>
             <div class="clr"></div>
          </div>
       </div>
    </div>
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-civil-check.js"></script> 
