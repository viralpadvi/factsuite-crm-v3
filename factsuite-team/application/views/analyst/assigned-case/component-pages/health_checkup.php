<?php 
  ...
  $health_check_id = isset($componentData['health_checkup_id'])?$componentData['health_checkup_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $health_check_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Health checkup Form Detail (Form<?php echo $num = ($index+1) ?>)</h3>
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/health_checkup.js"></script> 
