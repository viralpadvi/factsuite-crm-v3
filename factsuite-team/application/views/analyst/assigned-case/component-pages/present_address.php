<?php 
  ...
  $present_address_id =  isset($componentData['present_address_id'])?$componentData['present_address_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $present_address_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Present Address Form Detail</h3>
          <hr>
                     ...
                     <div class="row mt-3"> 
                        <div class="col-md-6">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control present_address_id" value="<?php echo $componentData['present_address_id']; ?>" id="present_address_id" type="hidden">
                            ...
                            <div class="col-md-7">
                              ...
                              <select class="fld form-control state select2" onchange="valid_state()" id="state">
                                ...
                                $city_id = '';
                                  $state = '';
                                  if($state != '' && $state != null){
                                    $state = $componentData['remarks_state'];
                                  }else{
                                    $state = 'Karnataka';
                                  }
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <input name="" class="fld form-control initiated_date mdate" value="<?php echo $componentData['initiated_date']; ?>" id="initiated_date" readonly type="text">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-present-address.js"></script>
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-present-address.js"></script>
