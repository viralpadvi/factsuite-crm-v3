<?php 
  ...
  $driving_license_id =  isset($componentData['licence_id'])?$componentData['licence_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $driving_license_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Driving License Form Detail</h3>
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/driving_licence.js"></script>
