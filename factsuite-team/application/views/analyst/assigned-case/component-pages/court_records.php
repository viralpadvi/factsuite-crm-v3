<?php 
  ...
  $court_rec_id =  isset($componentData['court_records_id'])?$componentData['court_records_id']:"0";
  ...
  if ($componentData['inputqc_status_date'] !='' && $componentData['inputqc_status_date'] !='NA' && $componentData['analyst_status_date'] != '' && $componentData['analyst_status_date'] != 'NA') {
      ...
      if (!$this->utilModel->check_date_format($analyst_specialist_status_date_time_splitted,'Y-m-d')) {
          ...
          $one = isset($analyst_specialist_status_date_splitted[1])?$analyst_specialist_status_date_splitted[1]:date('d');
          $two = isset($analyst_specialist_status_date_splitted[0])?$analyst_specialist_status_date_splitted[0]:date('m');
          $three = isset($analyst_specialist_status_date_splitted[2])?$analyst_specialist_status_date_splitted[2]:date('Y');*/
...
<input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $court_rec_id;?>">
...
<div class="pg-cnt">
    <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
        ...
        <h3 class="mt-3">Court Record Details (Form<?php echo $num = ($index+1) ?>)</h3>
        ...
        <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                    ...
                    <input type="hidden" name="court_records_id"
                        value="<?php echo $componentData['court_records_id']; ?>" id="court_records_id">
                    ...
                    $address_proof_doc= json_decode($componentData['address_proof_doc'],true);//$this->input->post('verification_remarks'),
                    ...
                    <div>
                        ...
                        <div class="row mt-3">
                            ...
                            <div class="col-md-4 ryt-p pl-0">
                                <p><?php echo isset($address[$index]['address'])?$address[$index]['address']:'No data found';?>
                                </p>
                                <p><?php echo isset($city[$index]['city'])?$city[$index]['city']:"No data found"?></p>
                                <p><?php echo isset($pincode[$index]['pincode'])?$pincode[$index]['pincode']:"No data found"?>
                                </p>
                                <p><?php echo isset($state[$index]['state'])?$state[$index]['state']:"No data found"?>
                                </p>
                                <p><?php echo isset($country[$index]['country'])?$country[$index]['country']:"No data found"?>
                                </p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row">
                        <div class="col-md-4">
                            <label class="permt mt-4">Address Docs</label>
                            <?php
                               // $rental_agreement = '';
                                 if (isset($address_proof_doc[$index])) {
                                 if (!in_array('no-file',explode(',', $address_proof_doc[$index]))) {
                                   foreach (explode(',', $address_proof_doc[$index]) as $key1 => $value) {
                                      if ($value !='') {
                                        $url = base_url()."../uploads/address-docs/".$value;
              ...
              gov_utility_bill -->
                    ...
                    <h3 class="permt mt-4">Court Record Verification Details <?php echo $j?></h3>
                    ...
                    <div class="row mt-3">
                        <div class="col-md-6">
                            ...
                            <div class="row mt-2 d-none">
                                ...
                                <div class="col-md-7">
                                    <textarea class="fld form-control address"
                                        onkeyup="valid_address(<?php echo $j; ?>)"
                                        onblur="valid_address(<?php echo $j; ?>)" rows="4" id="address<?php echo $j; ?>"
                                        spellcheck="false"><?php echo isset($remark_address[$index]['address'])?$remark_address[$index]['address']:''; ?></textarea>
                            ...
                            <div class="row mt-2 d-none">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <select class="fld form-control state select2" id="state<?php echo $j; ?>"
                                        onchange="valid_state(<?php echo $j; ?>)">
                                        <?php
                                // print_r($states);
                            ...
                            <div class="row mt-2 d-none">
                                ...
                                <div class="col-md-7">
                                    ...
                                    <select class="fld form-control city select2"
                                        value="<?php echo isset($remarks_city[$index]['city'])?$remarks_city[$index]['city']:''; ?>"
                                        onchange="valid_city(<?php echo $j; ?>)" onblur="valid_city(<?php echo $j; ?>)"
                                        id="city<?php echo $j; ?>">
                                        <?php 
                            ...
                            <div class="row mt-2 d-none">
                                ...
                                <div class="col-md-7">
                                    <input name="" class="fld form-control pincode"
                                        value="<?php echo isset($remark_pin_code[$index]['pincode'])?$remark_pin_code[$index]['pincode']:''; ?>"
                                        oninput="if (/\D/g.test(this.value)) this.value = this.value.replace(/\D/g,'')"
                                        onkeyup="valid_pincode(<?php echo $j; ?>)"
                                        onblur="valid_pincode(<?php echo $j; ?>)" id="pincode<?php echo $j; ?>"
                                        type="text">
                    ...
                    <div class="row mt-2">
                      ...
                      ?>
                          ...
                          if($userRole != 'insuff analyst'){  ?>
                                ...
                                <?php } ?>
                                <option class="text-capitalize" <?php echo $insuffStatus ?> value="3">Insufficiency
                                </option>
                                <?php 
                          if($userRole != 'insuff analyst'){  ?>
                                ...
                                <?php } else { ?>
                                <option class="text-capitalize" <?php echo $ni ?> value="11">Not Insufficiency</option>
                                <?php }
