<?php 
 ...
 $candidate_address =  isset($componentData['candidate_addresss'])?$componentData['candidate_addresss']:"-";
  ...
  $right_to_work_id = isset($componentData['right_to_work_id'])?$componentData['right_to_work_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $right_to_work_id;?>">
  <input type="hidden" id="right_to_work_id" value="<?php echo $right_to_work_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Right To Work Detail (Form<?php echo $num = ($index+1) ?>)</h3>
          <hr>
            ...
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <?php 
                    ...
                    $approved_doc=  explode(',',$componentData['approved_doc']);
                    ...
                    <div>
                      ...
                      <div class="row mt-3"> 
                         ...
                         <div class="col-md-4 ryt-p pl-0">
                            <p><?php echo isset($document_number[$index]['document_number'])?$document_number[$index]['document_number']:'No data found';?></p>
                            <p><?php echo isset($mobile_number[$index]['mobile_number'])?$mobile_number[$index]['mobile_number']:"No data found"?></p>
                            <p><?php echo isset($first_name[$index]['first_name'])?$first_name[$index]['first_name']:"No data found"?></p>
                            <p><?php echo isset($last_name[$index]['last_name'])?$last_name[$index]['last_name']:"No data found"?></p>
                            <p><?php echo isset($dob[$index]['dob'])?$dob[$index]['dob']:"No data found"?></p>
                            <p><?php echo isset($gender[$index]['gender'])?$gender[$index]['gender']:"No data found"?></p>
                         </div>
                      </div>
                    </div>
                    <h3 class="permt mt-4">Right To Work Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                          ...
                          <div class="row mt-2">
                            ...
                            <div class="col-md-7">
                              <select class="fld form-control gender" id="gender<?php echo $j; ?>">
                                ...
                                <?php
                                $selected_gender = isset($remark_gender[$index]['remark_gender']) ? $remark_gender[$index]['remark_gender'] : '';
                                        ...
                                        <?php
                                          $pan_card_doc = '';
                                            if (isset($approved_doc)) {
                                              if (!in_array('no-file',  $approved_doc)) {
                                               foreach ($approved_doc as $key1 => $value) {
                                                ...
                                                $pan_card_doc = isset($approved_doc[$index])?$approved_doc[$index]:'';
                                              }
                                            } 
                                        ?>
                                      </div>
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-right-to-work.js"></script> 
