<?php 
  ...
  $cv_check_id = isset($componentData['cv_id'])?$componentData['cv_id']:"0";
...
<input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $cv_check_id;?>">
...
<div class="pg-cnt">
    <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
        ...
        <h3 class="mt-3">CV Form Detail</h3>
        ...
        <div class="container detail">
            ...
            <div class="row mt-4">
                ...
                <div class="col-md-2 ryt-p pl-0 lft-p-det">
                    ...
                    <p><?php echo isset($componentData['contact_start_time'])?$componentData['contact_start_time']:'NA';?>
                    </p>
                    <p><?php echo isset($componentData['contact_end_time'])?$componentData['contact_end_time']:'NA';?>
                    </p>
                    <?php 
        ...
        <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                    ...
                    <input type="hidden" name="cv_id" value="<?php echo $componentData['cv_id']; ?>" id="cv_id">
                    ...
                    $full_name = isset($componentData['full_name'])?$componentData['full_name']:'did_not_comment';
                    $contect_number = isset($componentData['contect_number'])?$componentData['contect_number']:'did_not_comment';
                    $candidate_address = isset($componentData['address'])?$componentData['address']:'did_not_comment';
                    $education_detail = isset($componentData['education_detail'])?$componentData['education_detail']:'did_not_comment';
                    $employment_duration = isset($componentData['employment_duration'])?$componentData['employment_duration']:'did_not_comment';
                    $designation_held = isset($componentData['designation_held'])?$componentData['designation_held']:'did_not_comment';
                    $complete_emp_info = isset($componentData['complete_employment_info'])?$componentData['complete_employment_info']:'did_not_comment';

  
                    // full Name 
                    $full_name_did_not_comment = '';
                    $full_name_match = '';
                    $full_name_mismatch = '';

                    if($full_name == 'match') {
                      $full_name_match = 'selected';
                    }else if($full_name == 'mismatch'){
                      $full_name_mismatch = 'selected';
                    }else if($full_name == 'did_not_comment'){
                      $full_name_did_not_comment = 'selected';
                    }

                    // contect_number
                    $contect_number_did_not_comment = '';
                    $contect_number_match = '';
                    $contect_number_mismatch = '';
                    if($contect_number == 'match') {
                      $contect_number_match = 'selected';
                    }else if($contect_number == 'mismatch'){
                      $contect_number_mismatch = 'selected';
                    }else if($contect_number == 'did_not_comment'){
                      $contect_number_did_not_comment = 'selected';
                    }


                    // candidate_address
                    $candidate_address_did_not_comment = '';
                    $candidate_address_match = '';
                    $candidate_address_mismatch = '';
                    if($candidate_address == 'match') {
                      $candidate_address_match = 'selected';
                    }else if($candidate_address == 'mismatch'){
                      $candidate_address_mismatch = 'selected';
                    }else if($candidate_address == 'did_not_comment'){
                      $candidate_address_did_not_comment = 'selected';
                    }


                     // education_detail
                    $education_detail_did_not_comment = '';
                    $education_detail_match = '';
                    $education_detail_mismatch = '';
                    if($education_detail == 'match') {
                      $education_detail_match = 'selected';
                    }else if($education_detail == 'mismatch'){
                      $education_detail_mismatch = 'selected';
                    }else if($education_detail == 'did_not_comment'){
                      $education_detail_did_not_comment = 'selected';
                    }


                    // employment_duration 
                    $employment_duration_did_not_comment = '';
                    $employment_duration_match = '';
                    $employment_duration_mismatch = '';
                    if($employment_duration== 'match') {
                      $employment_duration_match = 'selected';
                    }else if($employment_duration == 'mismatch'){
                      $employment_duration_mismatch = 'selected';
                    }else if($employment_duration == 'did_not_comment'){
                      $employment_duration_did_not_comment = 'selected';
                    }

                    // designation_held
                    $designation_held_did_not_comment = '';
                    $designation_held_match = '';
                    $designation_held_mismatch = '';
                    if($designation_held== 'match') {
                      $designation_held_match = 'selected';
                    }else if($designation_held == 'mismatch'){
                      $designation_held_mismatch = 'selected';
                    }else if($designation_held == 'did_not_comment'){
                      $designation_held_did_not_comment = 'selected';
                    }


                    // complete_emp_info
                    $complete_emp_info_did_not_comment = '';
                    $complete_emp_info_match = '';
                    $complete_emp_info_mismatch = '';
                    if($complete_emp_info== 'match') {
                      $complete_emp_info_match = 'selected';
                    }else if($complete_emp_info == 'mismatch'){
                      $complete_emp_info_mismatch = 'selected';
                    }else if($complete_emp_info == 'did_not_comment'){
                      $complete_emp_info_did_not_comment = 'selected';
                    }
                    ...
                    <!--   -->
                    <div>
                        <h3 class="permt mt-4">CV Details</h3>
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <div class="row mt-2">
                        ...
                        <div class="row mt-3">
                            ...
                            // view_image(0,'candidate_aadhar')
                                $cv_doc = $componentData['cv_doc'];
                              // foreach ($pan_card_doc as $key => $value) { 
                                $ext = pathinfo($cv_doc, PATHINFO_EXTENSION);
                                $url = base_url()."../uploads/cv-docs/".$cv_doc;
                                // echo "cv_doc: ".$cv_doc;
                            ...
                            <div class="col-md-4">
                                ...
                                <div class="col-md-12 mt-3 pl-0 pr-0" id="file_vendor_documents_0">
                                    <div class="image-selected-div">
                                        <ul class="p-0 mb-0">
                                            <li class="image-selected-name pb-0"><?php echo $cv_doc ?></li>
                                            <li class="image-name-delete pb-0">
                                                <a id="docs_modal_file<?php echo $candidateId ?>"
                                                    onclick="view_document_modal(<?php echo "'".$url."'" ?>,'cv-docs')"
                                    ...
                                    <div class="image-selected-div">
                                        <ul class="p-0 mb-0">
                                            ...
                                            <li class="image-name-delete pb-0">
                                                ...
                                                <!-- <a download target="_blank" id="docs_modal_file<?php //echo $candidateId ?>" 
                                            href="<?php //echo  $url?>" class="image-name-delete-a">
                                              <i class="fa fa-arrow-down text-primary"></i>
                                        </a> -->
                                            </li>
                        ...
                        <h3 class="permt mt-4">CV Check Verification Details <?php echo $j?></h3>
                        <div class="row mt-3">
                            <div class="col-md-6">
                                <!-- Country List -->
                                <div class="row">
                               ...
                               ?>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-7">
                                        <textarea class="fld form-control progress_remarks"
                                            onkeyup="valid_progress_remarks(<?php echo $j; ?>)"
                                            onblur="valid_progress_remarks(<?php echo $j; ?>)"
                                            id="progress_remarks<?php echo $j; ?>"><?php echo isset($in_progress_remarks[$index]['progress_remarks'])?$in_progress_remarks[$index]['progress_remarks']:''; ?></textarea>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-7">
                                        <textarea class="fld form-control verification_remarks"
                                            onkeyup="valid_verification_remarks(<?php echo $j; ?>)"
                                            onblur="valid_verification_remarks(<?php echo $j; ?>)"
                                            id="verification_remarks<?php echo $j; ?>"><?php echo isset($verification_remarks[$index]['verification_remarks'])?$verification_remarks[$index]['verification_remarks']:''; ?></textarea>
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-7">
                                        ...
                                        <input name="" class="fld form-control mdate verified_date"
                                            ...
                                            id="verified_date<?php echo $j; ?>" type="text">
                                ...
                                <div class="row mt-2">
                                    ...
                                    <div class="col-md-7">
                                        <textarea class="fld form-control closure_remarks"
                                            onkeyup="valid_closure_remarks(<?php echo $j; ?>)"
                                            onblur="valid_closure_remarks(<?php echo $j; ?>)"
                                            id="closure_remarks<?php echo $j; ?>"><?php echo isset($Insuff_closure_remarks[$index]['closure_remarks'])?$Insuff_closure_remarks[$index]['closure_remarks']:''; ?></textarea>
                                        <div id="closure_remarks-error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                        <p class="det">Candidate Full Name</p>
                                    </div>
                                    <div class="col-md-2 pr-0">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-7">
                                        <select class="fld form-control candidate_full_name" id="candidate_full_name">
                                            <option <?php echo $full_name_did_not_comment ?> value="did_not_provide">Did
                                                Not Provide</option>
                                            <option <?php echo $full_name_match ?> value="match">Match</option>
                                            <option <?php echo $full_name_mismatch ?> value="mismatch">Mismatch</option>
                                        </select>
                                        <div id="candidate_full_name_error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                                <!-- file uoload -->
                                <div class="row mt2">
                                        ...
                                        <ul>
                                            <li class="vendor-wdt2">
                                                ...
                                                <div class="form-group mb-0">
                                                    <input type="file" class="client-documents" id="client-documents"
                                                        name="criminal-documents[]" multiple="multiple">
                            ...
                            <div class="col-md-6">
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                        <p class="det">Contect Number</p>
                                    </div>
                                    <div class="col-md-2 pr-0">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-7">
                                        <select class="fld form-control contact_number" id="contact_number">
                                            <option <?php echo  $contect_number_did_not_comment?>
                                                value="did_not_provide">Did Not Provide</option>
                                            <option <?php echo $contect_number_match ?> value="match">Match</option>
                                            <option <?php echo $contect_number_mismatch ?> value="mismatch">Mismatch
                                            </option>
                                        </select>
                                        <div id="contact_number_error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                    ...
                                    <div class="col-md-7">
                                        <select class="fld form-control candidate_address" id="candidate_address">
                                            <option <?php echo $candidate_address_did_not_comment ?>
                                                value="did_not_provide">Did Not Provide</option>
                                            <option <?php echo $candidate_address_match ?> value="match">Match</option>
                                            <option <?php echo $candidate_address_mismatch ?> value="mismatch">Mismatch
                                            </option>
                                        </select>
                                        <div id="candidate_address_error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                        <p class="det">Education Details</p>
                                    </div>
                                    <div class="col-md-2 pr-0">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-7">
                                        <select class="fld form-control education_details" id="education_details">
                                            <option <?php echo $education_detail_did_not_comment ?>
                                                value="did_not_provide">Did Not Provide</option>
                                            <option <?php echo $education_detail_match ?> value="match">Match</option>
                                            <option <?php echo $education_detail_mismatch ?> value="mismatch">Mismatch
                                            </option>
                                        </select>
                                        <div id="education_details_error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                        <p class="det">Employement Duration</p>
                                    </div>
                                    <div class="col-md-2 pr-0">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-7">
                                        <select class="fld form-control employement_duration" id="employement_duration">
                                            <option <?php echo $employment_duration_did_not_comment ?>
                                                value="did_not_provide">Did Not Provide</option>
                                            <option <?php echo $employment_duration_match ?> value="match">Match
                                            </option>
                                            <option <?php echo $employment_duration_mismatch ?> value="mismatch">
                                                Mismatch</option>
                                        </select>
                                        <div id="employement_duration_error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                        <p class="det">Designation Held</p>
                                    </div>
                                    <div class="col-md-2 pr-0">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-7">
                                        <select class="fld form-control designation_held" id="designation_held">
                                            <option <?php echo  $designation_held_did_not_comment?>
                                                value="did_not_provide">Did Not Provide</option>
                                            <option <?php echo $designation_held_match  ?> value="match">Match</option>
                                            <option <?php echo $designation_held_mismatch ?> value="mismatch">Mismatch
                                            </option>
                                        </select>
                                        <div id="designation_held_error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                                <div class="row mt-2">
                                    <div class="col-md-3">
                                        <p class="det">Complete Employement Information</p>
                                    </div>
                                    <div class="col-md-2 pr-0">
                                        <p>:</p>
                                    </div>
                                    <div class="col-md-7">
                                        <select class="fld form-control complete_emp_info" id="complete_emp_info">
                                            <option <?php echo $complete_emp_info_did_not_comment?>
                                                value="did_not_provide">Did Not Provide</option>
                                            <option <?php echo $complete_emp_info_match ?> value="match">Match</option>
                                            <option <?php echo $complete_emp_info_mismatch ?> value="mismatch">Mismatch
                                            </option>
                                        </select>
                                        <div id="ccomplete_emp_info_error<?php echo $j; ?>">&nbsp;</div>
                                    </div>
                                </div>
                            </div>
                        </div>
                  ...
                  ?>
                    <div class="row mt-2">
                      ...
                      ?>
                            ...
                            <select id="action_status" <?php echo $disabled." ".$outputQCStatus; ?> name="carlist"
                                class="sel-allcase">
                                <option class="text-capitalize" <?php echo $defaultStatus ?> value="0">Select your
                                    Action</option>
                                <?php                           
                          if($userRole != 'insuff analyst'){  ?>
                                <option class="text-capitalize" <?php echo $progress ?> value="1">In Progress</option>
                                <?php } ?>
                                <option class="text-capitalize" <?php echo $insuffStatus ?> value="3">Insufficient
                                </option>
                                <?php 
                          if($userRole != 'insuff analyst'){  ?>
                                <option class="text-capitalize" <?php echo $verifiedclearStatus ?> value="4">Verified
                                    Clear</option>
                                <option class="text-capitalize" <?php echo $stopcheckStatus ?> value="5">Stop check
                                </option>
                                <option class="text-capitalize" <?php echo $utv ?> value="6">Unable to verify</option>
                                <option class="text-capitalize" <?php echo $vd ?> value="7">Verified discrepancy
                                </option>
                                <option class="text-capitalize" <?php echo $cc ?> value="8">Client clarification
                                </option>
                                <option class="text-capitalize" <?php echo $ci ?> value="9">Closed Insufficiency
                                </option>
                                <?php } else { ?>
                  ...
                  $this->load->view('vendor/vendor-assign-to-component-form',$data); ?>
                    <div class="row d-none">
                        <div class="col-md-12 text-right">
                            ...
                            <a class="btn bg-blu btn-submit mt-4" data-toggle="modal"
                                data-target="#add-new-error-modal">
                    ...
                    <div class="row">
                        <div class="col-md-12 text-right">
                            <a class="btn bg-blu btn-submit mt-4 d-none" data-toggle="modal"
                                data-target="#add-new-client-clarification-modal">
                                <span class="text-white">Raise Client Clarification</span>
                            </a>
                  ...
                  if($analyst_status == '10'){?>
                    <div class="row mt-2">
                        <div class="col-md-6">
                            ...
                            <textarea class="fld form-control ouputQcComment" id="ouputQcComment"
...
<div id="sendMail" class="modal fade">
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            <div class="modal-pending-bx">
                <h3 class="snd-mail-pop">Send Mail <img
                        src="<?php echo base_url()?>assets/admin/images/email_open_100px.png" alt=""> </h3>
                <div class="row mt-3">
                    <div class="col-md-4">
...
?>
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/cv_check.js"></script>
