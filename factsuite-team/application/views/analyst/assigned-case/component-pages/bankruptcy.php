<?php 
  ...
  $bankruptcy_id =  isset($componentData['bankruptcy_id'])?$componentData['bankruptcy_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $bankruptcy_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3><?php //echo $statusLink; ?></h3> -->
          ...
          <h3 class="mt-3">Bankruptcy Check Detail </h3>
          ...
          <section id="table-allcase">
            <div class="container">
                <div class="detail mb-5">
                 ...
                 <input type="hidden" name="bankruptcy_id" value="<?php echo $componentData['bankruptcy_id']; ?>" id="bankruptcy_id">
                  ...
                  <?php 
                    ...
                    $bankruptcy_number= json_decode($componentData['bankruptcy_number'],true);
                    ...
                    <!--   -->
                    <!-- <div> -->
                      <h3 class="permt mt-4">Bankruptcy Check</h3> 
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                             <div class="col-md-2 lft-p-det">
                              ...
                              <div class="col-md-4 ryt-p pl-0">
                                 <p><?php echo $document_type[$index]['document_type'];?></p>
                                 <p><?php echo $bankruptcy_number[$index]['bankruptcy_number'];?></p>
                    ...
                    <hr> 
                    <h3 class="permt mt-4">Bankruptcy Check Verification Details <?php echo $j?></h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <!-- Country List -->
                          <div class="row">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/bankruptcy.js"></script>
