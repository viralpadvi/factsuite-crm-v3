<?php 
  ...
  $politically_exposed_id =  isset($componentData['politically_exposed_id'])?$componentData['politically_exposed_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" value="<?php echo $politically_exposed_id ?>" id="politically_exposed_id" name="politically_exposed_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $politically_exposed_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">Politically Exposed Person Form Detail</h3>
          <hr>
            ...
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <?php 
                    ...
                    <div>
	                    <h3 class="permt mt-4">Politically Exposed Person(Candidate filled)</h3>
	                    <div class="row mt-3"> 
                          	<div class="col-md-6">
	                       		<div class="row mt-2">
                    ...
                    <h3 class="permt mt-4">Politically Exposed Person Verification Details </h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                            <div class="col-md-3">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-politically-exposed.js"></script>
