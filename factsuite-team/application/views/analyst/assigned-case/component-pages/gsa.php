<?php 
  ...
  $gsa_id =  isset($componentData['gsa_id'])?$componentData['gsa_id']:"0";
...
<input type="hidden" value="<?php echo $component_id?> " id="component_id" name="component_id">
  ...
  <input type="hidden" value="<?php echo $gsa_id ?>" id="gsa_id" name="gsa_id">
  ...
  <input type="hidden" id="selected-hidden-user-component-form-filled-id" value="<?php echo $gsa_id;?>">
  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt-analyst">
         <!-- <h3>Case Detail</h3> -->
          ...
          <h3 class="mt-3">GSA Form Detail</h3>
          <hr>
            ...
            <div class="container">
                <div class="detail mb-5">
                  ...
                  <?php 
                    ...
                    <div>
	                    <h3 class="permt mt-4">GSA(Candidate filled)</h3>
	                    <div class="row mt-3"> 
                          	<div class="col-md-6">
	                       		<div class="row mt-2">
                    ...
                    <h3 class="permt mt-4">GSA Verification Details </h3>
                      <div class="row mt-3"> 
                        <div class="col-md-6">
                          <div class="row mt-2">
                            <div class="col-md-3">
...
<script src="<?php echo base_url() ?>assets/custom-js/analyst/remarks/remark-gsa.js"></script>
