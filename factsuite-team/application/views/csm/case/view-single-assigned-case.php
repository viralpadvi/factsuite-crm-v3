  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt">
         <!-- <h3>Case Detail</h3> -->
          ...
          <div class="row">
            <div id="priority-div" class="col-md-6">
               <!-- priority dropdown in JS --> 
            </div> 
            <div class="col-md-4">
                <label class="font-weight-bold" id="candidate-loa">LOA &nbsp;&nbsp;&nbsp;<a target="_blank" href="<?php echo $this->config->item('my_base_url').'factsuite-admin/candidate-loa-pdf/'.md5($candidate_id); ?>"><i class="fa fa-file-pdf-o"></i></a></label>
            </div>
             <div class="col-md-4"> 
...
<script src="<?php echo base_url() ?>assets/custom-js/csm/view-single-case.js"></script>
<script>
