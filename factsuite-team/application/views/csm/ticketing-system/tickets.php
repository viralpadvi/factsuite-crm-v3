...
<!-- custom-js -->
<script src="<?php echo base_url() ?>assets/custom-js/csm/ticketing/raise-ticket.js"></script>
<script src="<?php echo base_url() ?>assets/custom-js/csm/ticketing/all-tickets.js"></script>