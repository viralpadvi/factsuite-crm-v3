      ...
      <div class="pg-hdr-mn">
          <div id="FS-candidate-mn" class="add-team add-team-2 w-100">
            <ul class="nav nav-tabs nav-justified">
               ...
               <li class="nav-item">
                  <a class="nav-link active" href="<?php echo $this->config->item('my_base_url').'factsuite-admin/candidate-case-export'; ?>">All Reports</a>
               </li>
               <li class="nav-item">
                ...
                <li class="nav-item">
                  <a class="nav-link " href="<?php echo $this->config->item('my_base_url').'factsuite-admin/export-cases-allotted-to-vendor'; ?>">Cases Assigned To Vendor</a>
                </li>
            ...
            <div class="row mt-3">
              <div class="col-md-12">
                ...
                <select class="form-control input-txt" name="table" id="table">
                  <option selected value="">General Components Report</option>
                  <?php  
                        ...
                        echo  "<option value='insuff'>Insuff Report</option>"; 
                  ?>
              ...
              <div class="col-md-12 mt-3">
                <?php 
                // if($mis !=null){
                echo "<span class='text-danger'>* Note :General Component Report Created at ( ".$mis['report_created_date']." ).</span>";
                // }
                ?>
              </div>
