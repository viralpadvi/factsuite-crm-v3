      ...
      <div class="pg-hdr-mn">
          <div id="FS-candidate-mn" class="add-team add-team-2">
            <ul class="nav nav-tabs nav-justified">
               ...
               <li class="nav-item">
                  <a class="nav-link active" href="<?php echo $this->config->item('my_base_url').'factsuite-admin/inputqc-candidate-case-export'; ?>">Data Entry Report</a>
               </li>
                <li class="nav-item">
...
<!--Content-->
<script src="<?php echo base_url();?>assets/custom-js/inputqc/report/excel-report.js"></script>
  <script>
