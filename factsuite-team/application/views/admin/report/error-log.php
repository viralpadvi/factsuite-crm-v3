            ...
            <ul class="nav nav-tabs nav-justified">
               ...
               <li class="nav-item">
                ...
                <li class="nav-item">
                 ...
                 <li class="nav-item">
                  <a class="nav-link active" href="<?php echo $this->config->item('my_base_url').'factsuite-admin/component-error-log-export'; ?>">Error Log Report</a>
               </li> 
               <li class="nav-item">
...
<!--Content-->
<script src="<?php echo base_url();?>assets/custom-js/admin/report/excel-error-log-report.js"></script>
  <script>
