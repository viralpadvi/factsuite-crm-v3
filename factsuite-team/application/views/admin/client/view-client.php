...
<!--Content-->
  ...
  <!-- View Client SPOC's Modal Starts -->
   <div class="modal fade" id="show-client-spoc-list-modal">
      <div class="modal-dialog modal-dialog-centered modal-lg">
         <div class="modal-content">
            <div class="modal-header">
               <!-- <button type="button" class="close" data-dismiss="modal">&times;</button> -->
               <h4 class="modal-title">View Client SPOC's</h4>
            </div>
            <div class="modal-body modal-body-delete-coupon">
               <div class="table-responsive mt-3" id="">
                  <table class="table table-striped">
                     ...
                     <tbody class="tbody-datatable" id="get-client-spoc-list-data"></tbody>
                  </table>
               </div>
            </div>
         </div>
...
<script src="<?php echo base_url(); ?>assets/custom-js/admin/client/view-client.js?v=<?php echo time(); ?>"></script>
<script src="<?php echo base_url(); ?>assets/custom-js/admin/client/edit-client.js?v=<?php echo time(); ?>"></script>
<script src="<?php echo base_url(); ?>assets/custom-js/admin/client/client-spoc.js?v=<?php echo time(); ?>"></script>