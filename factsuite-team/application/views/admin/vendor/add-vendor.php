     ...
     <div id="FS-candidate-cnt">
        ...
        <div class="add-vendor-bx">
              ...
              <div class="col-md-4">
                 <div class="add-vendor-bx2">
                    ...
                    <ul>
                       ...
                       <li class="vendor-wdt2 d-none">
                          <label>TAT</label>
                          <input type="text" class="fld3 form-control " id="vendor-tat-old" name="vendor-tat-old" placeholder="">
           ...
           <ul>
            ...
            <div class="text-center" id="add-vendor-main-error-msg-div"></div>
          <div class="sbt-btns">
            <button class="btn bg-gry btn-submit-cancel" id="cancel-new-vendor-btn" onclick="cancel_add_new_vedor()">CANCEL</button>
           <button class="btn bg-blu btn-submit-cancel" id="add-new-vendor-btn" onclick="add_new_vendor()">SUBMIT &amp; SAVE</button>
        </div>
     </div>
  </div>
</section>
...
<script src="<?php echo base_url();?>assets/custom-js/admin/vendor/add-vendor.js"></script>