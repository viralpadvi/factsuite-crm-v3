          ...
          <div class="row mt-3">
            <div class="col-sm-12 text-right sbt-btns">
              <button class="btn bg-gry btn-submit-cancel ml-2" id="cancel-edit-btn" name="cancel-edit-btn" data-dismiss="modal">Cancel</button>
               <!-- <button class="btn bg-gry btn-submit-cancel ml-2" id="cancel-edit-btn" name="cancel-edit-btn" onclick="getTatValue()">Cancel</button> -->
...
<script src="<?php echo base_url();?>assets/custom-js/admin/vendor/get-all-vendor.js"></script>
