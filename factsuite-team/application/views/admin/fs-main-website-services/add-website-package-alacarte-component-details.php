  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt pt-3">
        <div class="add-client-bx">
           <h3>Package Alacarte Details</h3>
           <div class="card">
           	<div class="row m-2">
                <div class="col-md-6">
                ...
                <div class="col-md-6 mt-3">
           		...
           		<div class="col-md-6 mt-3">
                    ...
                    <select class="form-control fld auto-width" id="alacarte-component-details" >
                        ...
                        <?php foreach ($package_details['selected_package_alacarte_component_list'] as $key => $value) { ?>
           ...
           <div id="display-alacarte-component-details"></div>

      
         <div class="text-center" id="package-component-error"></div>  
        <div class="sbt-btns">
           <a class="d-none" href="javascript::" id="clear-form" data-toggle="modal" data-target="#cancel-form-modal" class="btn bg-gry btn-submit-cancel">CANCEL</a>
   ...
   <div class="modal fade" id="view-component-data" role="dialog">
    <div class="modal-dialog modal-lg">
      <div class="modal-content">
        ...
        <div class="modal-footer">
          <div class="header-mn text-center">
              <a href="" data-dismiss="modal" class="d-none exit-btn float-center text-center">Close</a>
              
           	<!-- <button id="add-website-service-alacarte-component-btn" class="btn bg-blu btn-submit-cancel text-white">submit</button> -->
...
<script src="<?php echo base_url(); ?>assets/custom-js/admin/factsuite-website/service-package/add-new-package-alacarte-component-details.js"></script>