  ...
  <div class="pg-cnt">
     <div id="FS-candidate-cnt" class="FS-candidate-cnt pt-3">
        ...
        <div class="add-client-bx">
           ...
           <div class="card">
            <div class="row p-3">
              ...
              <div class="col-md-6 mt-3">
                ...
                <?php 
                  $selected_package_components = explode(',',$selected_package_component_list['package_selected_component_and_alacarte_list']['package_components']);
                ?>
                
                <?php 
                  $selected_components_array = [];
                  $test_array = [];
                  foreach (json_decode($package['components_included_details'],true) as $key => $value) { 
                    array_push($selected_components_array,$value['component_id']);
                  }
                ?>
                <select class="form-control fld auto-width" id="component-selected" >
                  <?php
                  foreach ($selected_package_component_list['selected_package_component_list'] as $key => $value) { 
                    $disabled = '';
                    $selected = '';
           ...
           <div id="display-component-details">
             <?php
              ...
              $j = 1;
              $package_component = json_decode($package['components_included_details'],true);
        ...
        <div class="row ul<?php echo $com['package_id']; ?>">
          ...
          <label class="custom-control-label" for="customCheck<?php echo $com['package_id'].'_'.$com['component_id']; ?>"><?php echo $com['component_name']; ?></label>
          </div>
          </div>
          <div class="col-md-4 mt-1">
          ...
          $form_id =  isset($com['form_data'][$keys]['form_id'])?$com['form_data'][$keys]['form_id']:0;
            ...
            <label class="custom-control-label" for="customradiopackeducheckform_<?php echo $com['package_id'].'_'.$com['component_id']; ?>_<?php echo $i; ?>">Form <?php echo $i; ?></label><input type="hidden" class="form-control fld form" value="<?php echo $i; ?>" id="form_threshold<?php echo $i; ?>" >
            </div>
                  </div>
                  <div class="col-md-2 mt-1" >
 ...
 ?>
        ...
        <div class="sbt-btns">
          ...
          SAVE
          <?php if ($selected_package_component_list['package_selected_component_and_alacarte_list']['package_components'] != '') { ?>
              &amp; NEXT
          <?php } ?>
        </button>
        </div>
...
<script src="<?php echo base_url(); ?>assets/custom-js/admin/factsuite-website/service-package/update-package-component-details.js"></script>