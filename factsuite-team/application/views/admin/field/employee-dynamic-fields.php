     ...
     <div id="FS-candidate-cnt" class="FS-candidate-cnt" >
        ...
        if ($user['role'] !='admin') {
          ...
          if ($roles['role_action'] !='' && $roles['role_action'] !=null) {
            ...
            $employments = isset($role_action['mandate'])?$role_action['mandate']:array();  
        ...
        if (in_array($user['role'], ['admin','csm']) || in_array(1, $employments)) {  
         ?>
        ...
        <div class="table-responsive" id="">
          <table class=" table table-striped" id="example1">
            <thead class="thead-bd-color">
              ...
              <input type="hidden" name="total_field_name" value="<?php echo isset($fields['employment_fields'])?$fields['employment_fields']:''; ?>" id="total_field_name">
            </thead>
...
<!--Content-->
<!-- custom-js -->
<script src="<?php echo base_url(); ?>assets/custom-js/admin/fields/view-employee-fields.js"></script> 
