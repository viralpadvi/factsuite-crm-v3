        ...
        <div class="table-responsive" id="">
          <table class=" table table-striped" id="example1">
            <thead class="thead-bd-color">
              ...
              <input type="hidden" name="total_field_name" value="<?php echo $fields['field_name']; ?>" id="total_field_name">
            </thead>
...
<!--Content-->
<!-- custom-js -->
<script src="<?php echo base_url(); ?>assets/custom-js/admin/fields/dynamic-view-fields.js"></script> 
