     ...
     <div id="FS-candidate-cnt" class="FS-candidate-cnt" >
         ...
         <div class="row">
             <div class="col-md-4">
                 ...
                 <input type="text" class="form-control fld" id="schedule-title" placeholder="Please Enter Title" name="">
...
<!--Content-->
<!-- custom-js -->
<script src="<?php echo base_url(); ?>assets/custom-js/admin/reminder/add-reminder.js"></script> 
