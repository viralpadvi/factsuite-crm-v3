          ...
          <table class="table-fixed  datatable table table-striped">
            <thead class="table-fixed-thead thead-bd-color">
              <tr>
                ...
                <!-- <th>View&nbsp;Details</th>    -->
                <th class="d-none">Generate&nbsp;BGV&nbsp;Report</th>  
                <th>Download&nbsp;BGV&nbsp;Report</th>  
              </tr>
            </thead>
            ...
            if ($value['is_submitted'] == '0') {
             ...
             <td class="text-center" id="download_genrate_<?php echo $value['candidate_id']; ?>"><a id="download_genrate_report_<?php echo $value['candidate_id']; ?>" target="_blank"  href="<?php echo $this->config->item('my_base_url'); ?>factsuite-admin/interim-report-pdf-download/<?php echo $value['candidate_id']; ?>"  class="insuf-btn"><i class="fa fa-download" aria-hidden="true"></i></a></td> 
             </tr> 
