...
<div style="margin-top: 200px;">
  <h5>Form Builder</h5> 
  <input type="text" id="form-name" class="fld col-md-6" value="<?php echo $details['form_name']; ?>" placeholder="Enter Template Name." name="">
  <input type="hidden" id="form_id" class="fld col-md-6" value="<?php echo $details['form_id']; ?>" name="">
...
<button class="btn bg-blu text-white" id="getJSON">Update Form</button>
...
function save_json_data(formData){
   ...
   var form_id = $("#form_id").val();
     $.ajax({  
            ...
            method: 'post',  
            dataType: 'json',  
            data: {js:formData,form_name:form_name,form_id:form_id},  
