...
class Common_User_Filled_Details_Component_Client_Clarifications extends CI_Controller {
	...
	function get_new_client_clarification_comments_notifications() {
		extract($_POST);
		...
		} else if (isset($verify_specialist_request) && $verify_specialist_request == 1) {
		...
		echo json_encode(array('status'=>'1','all_clarification_comments'=>$this->common_User_Filled_Details_Component_Client_Clarifications_Model->get_new_client_clarification_comments_notifications($logged_in_user_details)));
	}
	...
	function get_all_client_clarifications() {
		...
		echo json_encode(array('status'=>'1','all_clarifications'=>$this->common_User_Filled_Details_Component_Client_Clarifications_Model->get_all_client_clarifications($logged_in_user_details),'get_ticket_status_list'=>file_get_contents(base_url().'assets/custom-js/json/ticket-status-list.json')));
	}
	...
	function add_new_client_clarification_comment() {
		...
		echo json_encode(array('status'=>'1','clarification_details'=>$this->common_User_Filled_Details_Component_Client_Clarifications_Model->add_new_client_clarification_comment($logged_in_user_details)));
	}
	...
	function get_client_clarification_single_comment() {
		...
		echo json_encode(array('status'=>'1','clarification_details'=>$this->common_User_Filled_Details_Component_Client_Clarifications_Model->get_client_clarification_single_comment()));
	}
	...
	function get_single_client_clarifications_all_comments() {
		...
		echo json_encode(array('status'=>'1','clarification_details'=>$this->common_User_Filled_Details_Component_Client_Clarifications_Model->get_single_client_clarifications_all_comments($logged_in_user_details),'all_team_members'=>$this->teamModel->get_team_list()));
	}
