...
*/
	...
	state !='' && (candidate_aadhar.length > 0 ||(rental_agreement !='' && rental_agreement !=null)) ) {
 	// alert("Hello")
...
$("#add_address").html('<div class="spinner-grow text-success spinner-grow-sm" role="status"><span class="sr-only">Loading...</span></div>Loading...');
	...
	$.ajax({
            type: "POST",
              url: base_url+"candidate/update_candidate_address_insuff",
              data:formdata,
              dataType: 'json',
              contentType: false,
              processData: false,
...
function valid_house_flat(){
	...
	if (house_flat !='') {
		...
		$("#permenent-house-flat-error").html("<span class='text-danger error-msg-small'>Please select valid house flat</span>");
...
function valid_land_mark(){
	...
	if (land_mark !='') {
		...
		$("#permenent-land-mark-error").html("<span class='text-danger error-msg-small'>Please select valid land mark</span>");
...
function valid_street(){
	...
	if (street !='') {
		...
		$("#permenent-street-error").html("<span class='text-danger error-msg-small'>Please select valid street</span>");
...
function valid_area(){
	...
	if (area !='') {
		...
		$("#permenent-area-error").html("<span class='text-danger error-msg-small'>Please select valid area</span>");
...
function valid_end_date(){
	...
	if (end_date !='') {
		...
		$("#permenent-end-date-error").html("<span class='text-danger error-msg-small'>Please Sslect valid end date</span>");
