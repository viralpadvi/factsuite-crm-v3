<script>
   if(!/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      window.location = '<?php echo $this->config->item('my_base_url')?>'+'factsuite-candidate/candidate-signature';
   }
</script>
...
<div class="container">
   <div class="pg-cntr">
      <div class="pg-txt">
         <div class="pg-lft">Consent Form</div>
         <div class="pg-rgt">Step <?php echo count(explode(',', $component_ids))+2;?>/<?php echo count(explode(',', $component_ids))+2;?></div>
         <div class="clr"></div>
      </div>
      <div class="pg-frm">
         <div class="full-bx">
            ...
            <div class="row">
              ...
              ?>
                <div class="col-md-6 w-50">
                  <input type="radio" checked onchange="change_signature(1)" name="radio-select-sign" id="select-signature-pad" value="1"><span for="select-signature-pad">Signature Pad</span>
                </div>
              <?php } ?>
              <div class="col-md-6 w-50">
                <input type="radio" <?php echo $upload_signature_checked;?> onchange="change_signature(2)" name="radio-select-sign" value="2" id="select-upload-signature"><span for="select-upload-signature">Upload Signature</span>
              </div>
            </div>
            <?php $upload_signature_style = '';
              if ($candidate_details['document_uploaded_by'] != 'client') {
                $upload_signature_style = 'display:none;';
            ?>
              <div class="mt-3" id="signature-pad-div">
      ...
      <div class="row">
         ...
         <div class="col-md-12 mt-3">
            <div class="pg-submit text-center">
