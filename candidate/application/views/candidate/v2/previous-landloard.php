             ...
             $form_values = json_decode($form_values,true);
               // $total_ref = count(isset($form_values['previous_landlord_reference_check'])?$form_values['previous_landlord_reference_check']?array(1));
      ...
      for ($i=0; $i < $total_ref; $i++) {  
              ?>
					<div class="row">
						<div class="col-md-4 d-none">
							<div class="input-wrap">
				                 <input name="" class="sign-in-input-field tenant_name" name="tenant_name" id="tenant_name" value="<?php echo isset($tenant_name[$i]['tenant_name'])?$tenant_name[$i]['tenant_name']:''; ?>" type="text">
						 ...
						 <div class="col-md-6">
							<div class="input-wrap">
				                <input name="landlord_name" id="landlord_name<?php echo $i; ?>" class="sign-in-input-field  landlord_name" onkeyup="valid_name(<?php echo $i; ?>)" value="<?php echo isset($landlord_name[$i]['landlord_name'])?$landlord_name[$i]['landlord_name']:''; ?>" type="text">
                  ...
                  <div id="landlord_name-error<?php echo $i; ?>"></div> 
						 ...
						 <div class="col-md-6">
							<div class="input-wrap"> 
                  <input name="case_contact_no" id="case_contact_no<?php echo $i; ?>" class="sign-in-input-field case_contact_no" onkeyup="valid_contact_no(<?php echo $i; ?>)" value="<?php echo isset($case_contact_no[$i]['case_contact_no'])?$case_contact_no[$i]['case_contact_no']:''; ?>" type="text">
         ...
         ?>
					...
					<div class="row">
						...
						<div class="col-md-5">
							<button  id="add_reference_landload"  class="save-btn">Save &amp; Continue</button>
						</div>
					</div>
