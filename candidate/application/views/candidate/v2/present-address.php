		...
		<div class="row">
			...
			<div class="col-md-4">
				<div class="input-wrap">
	                <input type="text" class="sign-in-input-field" value="<?php echo isset($table['present_address']['flat_no'])?$table['present_address']['flat_no']:''; ?>" id="house-flat" required="">
			...
			<div class="col-md-4">
				<div class="input-wrap">
	                <input type="text" class="sign-in-input-field" required="" value="<?php echo isset($table['present_address']['street'])?$table['present_address']['street']:''; ?>" id="street">
			...
			<div class="col-md-4">
				<div class="input-wrap">
	                <input type="text" class="sign-in-input-field" required="" value="<?php echo isset($table['present_address']['area'])?$table['present_address']['area']:''; ?>" id="area">
			...
			<div class="col-md-4">
				<div class="input-wrap">
	                <input type="text" class="sign-in-input-field" required="" id="pincode" value="<?php echo isset($table['present_address']['pin_code'])?$table['present_address']['pin_code']:''; ?>">
			...
			<div class="col-md-4">
				<div class="input-wrap">
	                <input type="text" class="sign-in-input-field" required="" id="land-mark" value="<?php echo isset($table['present_address']['nearest_landmark'])?$table['present_address']['nearest_landmark']:''; ?>">
				...
				<div class="input-wrap">
					<select class="sign-in-input-field country" id="country" required>
                     	<option selected value=''>Select Country</option>
                      	<?php $get_country = isset($table['present_address']['country'])?$table['present_address']['country']:'';
                      	$c_id = '';
			...
			<div class="col-md-12">
				...
				$exploded_end_date = explode('-', isset($table['present_address']['duration_of_stay_end'])?$table['present_address']['duration_of_stay_end']:'');
				?>
			...
			<div class="col-md-6">
				<div class="input-wrap">
	                <input type="text" class="sign-in-input-field" required="" id="name" value="<?php echo isset($table['present_address']['contact_person_name'])?$table['present_address']['contact_person_name']:''; ?>">
			...
			<div class="col-md-3">
				<div class="input-wrap">
	                <select class="sign-in-input-field code" required="" id="code" >
                     	<?php $ccode = isset($table['present_address']['code'])?$table['present_address']['code']:'';
			...
			<div class="col-md-6">
				<div class="input-wrap">
	                <input name="" class="sign-in-input-field" id="contact_no" value="<?php echo isset($table['present_address']['contact_person_mobile_number'])?$table['present_address']['contact_person_mobile_number']:''; ?>" type="text">
