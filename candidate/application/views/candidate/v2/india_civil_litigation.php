					...
					<div class="row">
						<div class="col-md-4">
							<div class="input-wrap">
				                 <input name="" class="sign-in-input-field  first-name"  disabled onblur="valid_name()" onkeyup="valid_name()" value="<?php echo isset($table['india_civil_litigation']['first_name'])?$table['india_civil_litigation']['first_name']:$user['first_name']; ?>" id="first-name" type="text">
						...
						<div class="col-md-4">
							<div class="input-wrap">
				                 <input name="" class="sign-in-input-field  name"  disabled onblur="valid_name()" onkeyup="valid_name()" value="<?php echo isset($table['india_civil_litigation']['last_name'])?$table['india_civil_litigation']['last_name']:$user['last_name']; ?>" id="last-name" type="text">
						 ...
						 <div class="col-md-4">
							<div class="input-wrap">
				                 <input name="" class="sign-in-input-field  mdate" disabled onblur="valid_date_of_birth()" onkeyup="valid_date_of_birth()" value="<?php echo isset($table['india_civil_litigation']['dob'])?$table['india_civil_litigation']['dob']:$user['date_of_birth']; ?>" id="date_of_birth" type="text">
				...
				<div class="col-6">
					...
					<div class="row">
						...
						<div class="col-md-5">
							<button id="candidate-india-civil-litigation"  class="save-btn">Save &amp; Continue</button>
						</div>
					</div>
