<script>
   if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      window.location = '<?php echo $this->config->item('my_base_url')?>'+'m-document-check';
   }
</script>
   ...
   <div class="pg-cnt pt-3">
     <div class="pg-txt-cntr">
         <div class="pg-steps">Step <?php echo array_search('3',array_values(explode(',', $component_ids)))+2 ?>/<?php echo count(explode(',', $component_ids))+2;?></div>
         ...
         <div class="row mt-3">
          ...
          <div class="row mt-3"> 
               <?php  if (in_array(3, isset($form_values['document_check'])?$form_values['document_check']:array())) { ?> 
            <div class="col-md-3">
               <div class="pg-frm-hd">Upload Passport</div>
            </div>
               <?php } ?>
                <?php  if (in_array(1, isset($form_values['document_check'])?$form_values['document_check']:array())) { ?> 
            <div class="col-md-3">
               <div class="pg-frm-hd">Upload Pan Card</div>
            </div>
             <?php } ?>
              <?php  if (in_array(2, isset($form_values['document_check'])?$form_values['document_check']:array())) { ?> 
            <div class="col-md-3">
               <div class="pg-frm-hd">Upload Aadhar Card</div>
            </div>
             <?php } ?>
            
             <?php  if (in_array(4, isset($form_values['document_check'])?$form_values['document_check']:array())) { ?> 
            <div class="col-md-3">
               <div class="pg-frm-hd">Upload Voter Id Card</div>
            </div>
             <?php } ?> 
