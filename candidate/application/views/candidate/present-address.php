<script>
   if(/Android|webOS|iPhone|iPad|iPod|BlackBerry|IEMobile|Opera Mini/i.test(navigator.userAgent)) {
      window.location = '<?php echo $this->config->item('my_base_url')?>'+'m-present-address-1';
   }
</script>
<?php 
$months = array(
...
?>
   ...
   <div class="pg-cnt pt-4">
      <div class="pg-txt-cntr">
         <div class="pg-steps">Step <?php echo array_search('8',array_values(explode(',', $component_ids)))+2 ?>/<?php echo count(explode(',', $component_ids))+2;?></div>
         <span> <input type="checkbox" id="addresses" name=""> Copy details mentioned in personal details </span>
         <h6 class="full-nam2">Present Address</h6>
         <div class="row">
            <div class="col-md-4">
               <div class="pg-frm">
                  <label>House/Flat No.</label>
                  <input name="" class="fld form-control" value="<?php echo isset($table['present_address']['flat_no'])?$table['present_address']['flat_no']:''; ?>" id="house-flat" type="text">
            ...
            <div class="col-md-4">
               <div class="pg-frm">
                  ...
                  <input name="" class="fld form-control" value="<?php echo isset($table['present_address']['street'])?$table['present_address']['street']:''; ?>" id="street" type="text">
            ...
            <div class="col-md-4">
               <div class="pg-frm">
                  <label>Area</label>
                  <input name="" class="fld form-control" value="<?php echo isset($table['present_address']['area'])?$table['present_address']['area']:''; ?>" id="area" type="text">
         ...
         <div class="row">
           <!--  <div class="col-md-4">
               <div class="pg-frm">
                  ...
                  <input name="" class="fld form-control" value="<?php echo isset($table['present_address']['city'])?$table['present_address']['city']:''; ?>" id="city" type="text">
            ...
            <div class="col-md-4">
               <div class="pg-frm">
                  ...
                  <input name="" class="fld form-control" id="pincode" value="<?php echo isset($table['present_address']['pin_code'])?$table['present_address']['pin_code']:''; ?>" type="text">
            ...
            <div class="col-md-4">
               <div class="pg-frm">
                  ...
                  <input name="" class="fld form-control" id="land-mark" value="<?php echo isset($table['present_address']['nearest_landmark'])?$table['present_address']['nearest_landmark']:''; ?>" type="text">
               ...
               <label>Country</label> 
                   <select class="fld form-control country select2" id="country" >
                     <option selected value=''>Select Country</option>
                      <?php
                      // $get_country = isset($table['present_address']['country'])?$table['present_address']['country']:'India';
                ...
                <div class="pg-frm">
                   ...
                   <select class="fld form-control state select2"  id="state" >
                     <option selected value=''>Select State</option>
                      <?php 
                      $get_state = isset($table['present_address']['state'])?$table['present_address']['state']:'';
                   ...
                   <!-- <input name="" class="fld form-control city" value="<?php echo isset($city[$i]['city'])?$city[$i]['city']:''; ?>"  onkeyup="valid_city()" id="city" type="text"> -->
                    <select class="fld form-control city select2" id="city" >
                     <option selected value=''>Select City/Town</option>
                      <?php 
                      $get_city = isset($table['present_address']['city'])?$table['present_address']['city']:'';
         ...
         <?php $exploded_from_date = explode('-', isset($table['present_address']['duration_of_stay_start'])?$table['present_address']['duration_of_stay_start']:''); ?>
         <div class="row">
            <div class="col-md-3">
               <!--  <div>&nbsp;</div>
            ...
            <h6 class="To">TO</h6>
           <div class="col-md-4">
            <?php $exploded_end_date = explode('-', isset($table['present_address']['duration_of_stay_end'])?$table['present_address']['duration_of_stay_end']:''); ?>
            <!-- <div>&nbsp;</div>
         ...
         <div class="row">
            <div class="col-md-4">
               <div class="pg-frm">
                  <label>Name</label>
                  <input name="" class="fld form-control" id="name" value="<?php echo isset($table['present_address']['contact_person_name'])?$table['present_address']['contact_person_name']:''; ?>" type="text">
            ...
            <div class="col-md-3">
               <div class="pg-frm">
                  ...
                  <input name="" class="fld form-control" id="contact_no" value="<?php echo isset($table['present_address']['contact_person_mobile_number'])?$table['present_address']['contact_person_mobile_number']:''; ?>" type="text">
