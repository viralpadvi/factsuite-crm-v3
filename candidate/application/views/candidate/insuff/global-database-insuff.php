   ...
   <div class="pg-cnt pt-3">
       <div class="pg-txt-cntr">
         <div class="pg-steps">Step <?php echo array_search('5',array_values(explode(',', $component_ids)))+1 ?>/<?php echo count(explode(',', $component_ids))+1;?></div>
         <h6 class="full-nam2">Candidate Global Details</h6>
         <!-- <div class="row"> -->
        <!--     <div class="col-md-8">
               <div class="pg-frm">
                  <label>Address</label>
...
<script src="<?php echo base_url(); ?>assets/custom-js/candidate/insuff/candidate-global-database-insuff.js" ></script>
