...
<script>
    ...
    $('#timepicker,#timepicker2').on('change', function() {
        check_start_end_time();
    });

    function check_start_end_time() {
        var timepicker1 = $('#timepicker').val(),
            timepicker2 = $('#timepicker2').val();
        if(timepicker1 != timepicker2) {
            $('#timepicker2-error').html('');
            return 1;
        } else {
            $('#timepicker2-error').html('<span class="text-danger error-msg-small">Start time and End time cannot be same.</span>');
            $('#timepicker2').val('');
            return 0;
        }
    }
