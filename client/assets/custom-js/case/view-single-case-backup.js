                     ...
                     // alert(data[i].component_data.output_status+'qc')
                        ...
                        for (var k = 0; k < analyst_status.length; k++) {
                            ...
                            if (analyst_status[k] == '0') {
                                // analystStatus.push('Form '+n+': <span class="text-warning"> Pending </span>');                        
                                analystStatus = '<span class="case-status case-status-2 case-pending"> Pending </span>' ;                        
                            }/*else if (analyst_status[k] == '1') {
                                analystStatus.push('<span class="text-info"> Form Filled </span>');                        
                            }else if (analyst_status[k] == '2') {
                                analystStatus.push('<span class="text-success"> Completed </span>');                        
                            }*/else if (analyst_status[k] == '3') {
                                // analystStatus.push('<span class="text-danger"> Insufficiency </span>');                        
                                analystStatus = '<span class="case-status case-status-2 text-danger"> Insufficiency </span>';                        
                            }/*else if (analyst_status[k] == '4') {
                               analystStatus.push('<span class="text-success"> Approved </span>');                          
                            }else if (analyst_status[k] == '5') {
                                analystStatus.push('<span class="text-danger"> Stop Check </span>');                         
                            }else if (analyst_status[k] == '6') {
                                analystStatus.push('<span class="text-danger"> Unable to verify </span>');                          
                            }else if (analyst_status[k] == '7') {
                                analystStatus.push('<span class="text-danger"> Verified discrepancy </span>');                        
                            }*/else if (analyst_status[k] == '8') {
                                analystStatus = '<span class="case-status case-status-2 text-danger"> Client Clarification </span>';                         
                                // analystStatus.push('<span class="text-danger"> Client clarification </span>');                         
                            }/*else if (analyst_status[k] == '9') {
                                 analystStatus.push('<span class="text-danger"> Closed insufficiency</span>');                         
                            }*/else{
                                if(output_status[k] == '1'){
                                   analystStatus = '<span class="case-status case-status-2 case-completed"> Verified Clear </span>';                            
                                }else{ /* else if(output_status[k] == '2'){
                                   analystStatus.push('<span class="text-danger"> Rejected </span>');                            
                                }else{*/
                                    // analystStatus.push('<span class="text-warning"> In Progress </span>'); 
                                    analystStatus = '<span class="case-status case-status-2 case-in-progress"> In Progress </span>'; 
                                }                     
                            }
        ...
        success: function(data){  
            ...
            switch(component_id){
                ...
                case 25:
                    ...
                    break;
                 case 26:
                    civil_checks(data,component_name)
                    break;
                default:
                    break;
            }
...
function current_employment(data,component_name){
    ...
    if(data.status != '0'){
        ...
        html += '<span class="input-field-txt">Desigination</span>';
        html += '</div>';
        html += '</div>';
        // html += '               <div class="pg-frm">';
    ...
    if(data.status > 0){
        ...
        if(type_of_degree.length > 0){
            ...
            for (var i = 0; i < type_of_degree.length; i++) {
                ...
                html += '<span class="input-field-txt">Course Full / Part Time :</span>';
                ...
                html += '               <label class=" pt-1">Part Time</label>';
                ...
                html += '               <label class=" pt-1">Full Time</label>';
                }
                html += '            </div>';
                html += '         </div>';
...
function present_address(data,component_name){ 
    ...
    if(data.status > 0){
        ...
        html += '<span class="input-field-txt">Reletionship</span>';
        html += '</div>';
        html += '</div>';
        // html += '               <div class="pg-frm">';
