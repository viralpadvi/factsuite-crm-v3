$('#forgot-password-toggle-btn').on('click', function() {
    $('#forgot-password-ui-div').removeClass('d-none').addClass('d-block');
    $('#login-ui-div').removeClass('d-block').addClass('d-none');
});

$('#sign-in-toggle-btn').on('click', function() {
    $('#login-ui-div').removeClass('d-none').addClass('d-block');
    $('#forgot-password-ui-div').removeClass('d-block').addClass('d-none');
});
