                ...
                <div class="row">
                  <div class="col-md-7"> 
                    <div class="row mb-2">
                     ...
                     <select class="form-control d-inline kip-select " id="recievals_status1" onchange="get_yearly_cases()">
                      <option value="status">All Status</option>
                      <?php 
                         echo "<option value='0'>Initiate</option>";
                        echo "<option value='1'>Inprogress</option>";
                  ...
                  <div class="col-md-5 pl-0">
                    ...
                    <input type="text" name="from-date-recievals" id="from-date-recievals1" value="" placeholder="Select Date Range" class="form-control" style="width: 85%;">   
                  </div>
                    </div>

                    <div class="chart tab-pane active mt-2">
                      <canvas id="year_case_inventoty_chart" height="300" style="height: 300px;"></canvas>
                    </div>
                  </div>
                  <div class="col-md-5">
                    ...
                    <div class="row">
                      <div class="col-md-6">
                        <div class="cases-overview-kpi-div new-cases-count-kpi-div">
                          <p>New Cases</p>
                          <h4  id="home-page-total-case" ><?php 
                      ...
                      <div class="col-md-6">
                        <div class="cases-overview-kpi-div closed-cases-count-kpi-div">
                          <p>Closed Cases</p>
                          <h4  id="home-page-completed-case" ><?php 
                        ...
                        <div class="other-case-condition-count-kpi-div">
                          <div class="row">
                            <div class="col-md-2 col-6">
                              <p>Insuff</p>
                              <h4 id="home-page-insuff-case"><?php 
