...
$file_name_final = $candidate[0]['candidaetData']['candidate_id'].'-'.trim(strtolower($candidate[0]['candidaetData']['first_name'])).'_'.trim(strtolower($candidate[0]['candidaetData']['last_name'])).'-'.'interim-report.pdf';
...
<td style="padding-bottom: 15px; width: 2%;">:</td>
<td style="padding-bottom: 15px; width: 20%; font-weight: bold; font-size: 10px; color: #381653;">In-Progress</td>
<td></td>
</tr>
</table>
<table style="margin-top: 25px; color: #ffffff;
...
if (in_array($value1['component_id'],[1,2,3,4,7,10,11,12])) {
 ...
 $component_name = $value1['component_name'].' '.$value1['formNumber'];
    ...
    if ($value1['component_id'] == '7' || $value1['component_id'] == '3') {
        $component_name = $value1['value_type'];
    }
}else{
...
$html_criminal .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;line-height:30px;"> Criminal History '. ($x+1) .'</div>';
...
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;line-height:30px;"> Court Record '. ($v+1) .'</div>';
...
if (!in_array($analyst,['0','1','10','8','6','3','9','5'])) {
   $html .='<br pagebreak="true" />';
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px; line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> Drug Test '. ($a+1) .'</div>';
...
$html .='<br pagebreak="true" />';
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> '.$value['type_of_degree'].' </div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> Previous Employment '.($a+1).'</div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> Reference '.($a+1).'</div>';
...
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> Previous Address '.($a+1).'</div>';
...
if (!in_array($analyst_value,['0','1','10','8','6','3','9','5'])) {
 $html .='<br pagebreak="true" />';
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> Previous Landlord Reference Check</div>';
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> Covid-19 Check</div>';
...
if (!in_array($analyst,['0','1','10','8','6','3','9','5'])) {
 $html .='<br pagebreak="true" />';
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> Social Media Check</div>';
