...
$verifiy_img = base_url().'assets/client/images/marks/verify.png';
...
<body>
    <img style="display: block; margin-left: auto;margin-right: auto; width: 20%; margin-top: 50px;" src="<?php echo base_url(); ?>assets/client/images/FactSuite-logo.png" alt="" srcset=""> 
    ...
    <div style="padding: 35px 35px 45px 35px;background-color:#e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px; " >
        ...
        width: 100%;">
            ...
            <tr>
                ...
                <td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 18px; color: #381653;"><?php echo isset($table['document_check']['aadhar_number'])?$table['document_check']['aadhar_number']:''; ?><!-- <?php
            ...
            <tr>
                ...
                <td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 18px; color: #381653;"><?php echo isset($table['document_check']['pan_number'])?$table['document_check']['pan_number']:''; ?><!-- <?php
            ...
            <tr>
                ...
                <td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 18px; color: #381653;"><?php echo isset($table['document_check']['passport_number'])?$table['document_check']['passport_number']:''; ?><!-- <?php
...
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px;line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 18px;"> <i style="color: #381653; margin-right: 15px;" class="fa fa-signal" aria-hidden="true"></i> Driving Licence</div>';
