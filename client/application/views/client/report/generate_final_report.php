...
$cancel =  base_url().'assets/client/images/marks/cancel-16.png';
$check16px =  '<img src="'.base_url().'assets/client/images/marks/check16px.png" >';
$green_img = base_url().'assets/client/images/marks/green.png';
$verifiy_img = '<img height="400%" src="'.base_url().'assets/client/images/marks/verify.png" />';
 ...
 if(isset($_GET['report'])){
    if ($_GET['report'] =='red') {
       ...
       $color_code = '#e20404';
        ...
        $green_img = base_url().'assets/client/images/marks/red.png';
        $text_status = "RED REPORT";
    }else if($_GET['report'] =='orange'){
       
        $color_code = '#FF8C00';
        $bgcolor_code = '#FFD4AE';
        $green_img = base_url().'assets/client/images/marks/orange.png';
        $text_status = "ORANGE REPORT";
    }else if($_GET['report'] =='green'){
        $verifiy_img = "<h3 style='color:white;background-color:green;'>Verified Clear</h3>";
        $verifiy_img = '<img height="400%" src="'.base_url().'assets/client/images/marks/07.png" >';  
         $color_code = '#1F7705';
        $bgcolor_code = '#C5FCB4';  
...
$html .='<body>'; 
 ...
 $fs_logo = $this->db->where('client_id',$candidate[0]['candidaetData']['client_id'])->get('custom_logo')->row_array();
 if (isset($fs_logo['fs_logo']) && !empty($fs_logo['fs_logo'])) {
     $html .='<div align="center"><img style="" width="200px" src="'.base_url().'../uploads/client-docs/'.$fs_logo['fs_logo'].'" alt="" srcset="">';
 }else{

$html .='<div align="center"><img style="" width="200px" src="'.base_url().'assets/client/images/FactSuite-logo.png" alt="" srcset="">';
 }
...
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%" >'.$candidate[0]['candidaetData']['candidate_id'].'</td>
<td style="padding-bottom: 15px; font-size: 10px;" width="23%" >Date Requested</td>
<td style="padding-bottom: 15px;" width="2%" >:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%" >'.get_date($candidate[0]['candidaetData']['created_date']).'</td>
</tr>
<tr>
<td style="padding-bottom: 15px; font-size: 10px;" width="23%">Name Of Client</td>
<td style="padding-bottom: 15px;" width="2%">:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%">'.ucwords($data[0]['client_name']).'</td>
<td style="padding-bottom: 15px; font-size: 10px;"  width="23%" >Date Completed</td>
<td style="padding-bottom: 15px;" width="2%">:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%" >'.get_date($candidate[0]['candidaetData']['report_generated_date']).'</td>
</tr>
<tr>
...
<td style="padding-bottom: 15px;" width="2%" >:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%" >'.get_date($candidate[0]['candidaetData']['date_of_birth']).'</td>
</tr>
<tr>
<td style="padding-bottom: 15px; font-size: 10px;" width="23%">Employee ID</td>
<td style="padding-bottom: 15px;" width="2%">:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%">'.$candidate[0]['candidaetData']['employee_id'].'</td>
<td style="padding-bottom: 15px; font-size: 10px;" width="23%">Date of Joining</td>
<td style="padding-bottom: 15px;" width="2%">:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%">'.get_date($candidate[0]['candidaetData']['date_of_joining']).'</td>
</tr>
<tr>
<td style="padding-bottom: 15px; width: 23%; font-size: 10px;">Father\'s Name</td>
<td style="padding-bottom: 15px;" width="2%" >:</td>
<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px;" width="25%" >'.ucwords($candidate[0]['candidaetData']['father_name']).'</td>
</tr>
</table>
</div>
</div>
...
<td style="padding-bottom: 15px; width: 2%;">:</td>
<td style="padding-bottom: 15px; width: 20%; font-weight: bold; font-size: 10px; color: #381653;">Completed</td>
<td></td>
</tr>
</table>
<table style="margin-top: 25px; color: #ffffff;
...
<tbody style="padding: 10px; margin-top: 10px; background-color: #D2D4D1;">';  
    ...
    $components_get = array(); 
   $componentdata = $this->db->order_by('report_id','DESC')->where('component_id',$candidate[0]['candidaetData']['candidate_id'])->get('bgv_report_nomenclature')->row_array(); 
       if ($componentdata !=null && $componentdata !='') {
            $components_get = explode(',',$componentdata['component_list']);
        }  
    $num = 0;          
...
// if (count($components_get) == 0 || count($components_get) == null) { 
if (in_array($value1['component_id'],[1,2,3,4,7,10,11,12])) {
  ...
  $component_name = $value1['component_name'].' '.$value1['formNumber'];
    ...
    if ($value1['component_id'] == '7' || $value1['component_id'] == '3' ) {
...
/*}else{
    $component_name = isset($components_get[$num])?$components_get[$num]:$value1['component_name'];
}*/
$num++;
...
$html_criminal ='';
$check16px =  '<img width="16px" src="'.base_url().'assets/client/images/marks/check16px.png" >';
...
$html_criminal .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;line-height:30px;"> '.$components_array[$index]['component_name'].'</div>';
...
$html_criminal .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($verified_dates).'</td>';
...
$html_criminal .='<h1 style="text-align:center"> Annexure '.($max+1).'</h1>';
           /* if ($key1 !=0) {
            ...
            $html_criminal .='<tr>'; 
            $html_criminal .='<td align="center" style="padding-bottom: 20px; font-size: 18px;width:100%"><img style=" display: block;margin-left: auto;margin-right: auto;border: 1px solid #555;" '.$height.' src="'.$url.'"></td>'; 
            $html_criminal .='</tr>';
            $html_criminal .='</table>'; 
        $max++;
$html_criminal .='</div>';
...
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;line-height:30px;"> '.$components_array[$index]['component_name'].'</div>';
...
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($verified_dates).'</td>';
$html .='<td></td>';
...
$doc_display .='<tr>';
$doc_display .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Voter ID Number</td>';
$doc_display .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$voter_id.'</td>';
$doc_display .='<td></td>';
$doc_display .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$doc_display .='</tr>';
...
$doc_display .='<tr>';
$doc_display .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">SSN Number</td>';
$doc_display .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$ssn_number.'</td>';
$doc_display .='<td></td>';
$doc_display .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$doc_display .='</tr>';
...
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;">'.$type_name .'</div>';
...
$index = array_search('4_'.$in,array_column($components_array, 'id'));
 $in++;
$html .='<div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 40px; margin-right:80px; margin-left: 80px; line-height:20px; " >';
$html .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;"> '.$components_array[$index]['component_name'] .'</div>';
...
$html .='<tr>';
$html .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px;">Verified Date</td>'; 
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($table['globaldatabase']['verified_date']).'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px;">Verified Date</td>';
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($table['current_employment']['verified_date']).'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
/**/
...
if (!in_array($analyst,[0,1,5])) {
$ab = 0;
  if (isset($_GET['education']) && $ab ==0) {
    $ab = 1;
    $education = $_GET['education'];
}else{
     $education = $value['type_of_degree']; //' Global Database '. ($a+1);
}
...
$html .='<tr>';
$html .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px; ">Verified Date</td>';
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($table['present_address']['verified_date']).'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px; ">Verified Date</td>';
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($table['permanent_address']['verified_date']).'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<br pagebreak="true" />';
 if (isset($_GET['employment'])) {
    $employment = $_GET['employment'];
     ...
     $employment =' Previous Employment '.($a+1);
} 
...
if (!in_array($analyst,[0,1,5])) {
$html .='<br pagebreak="true" />';  
  if (isset($_GET['directorship'])) {
    $directorship = $_GET['directorship'];
}else{
     $directorship =' Directorship Check ';
}  
...
$html .='<br pagebreak="true" />'; 
  if (isset($_GET['global_'])) {
    $global = $_GET['global_'];
}else{
     $global =' Global Sanctions/ AML ';
}  
...
$html .='<tr>';
$html .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px; ">Verified Date</td>';
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($table['driving_licence']['verified_date']).'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
// 
...
if (isset($table['adverse_database_media_check']['adverse_database_media_check_id'])) {
    ...
    $candidate_name = $candidate[0]['candidaetData']['first_name'].' '.$candidate[0]['candidaetData']['last_name']; 
...
$html .='<br pagebreak="true" />'; 
   if (isset($_GET['media'])) {
    $media = $_GET['media'];
     ...
     $media =' Adverse Media/Database Check ';
} 
$in = 1;
 ...
 $html .='<br pagebreak="true" />';
  if (isset($_GET['landlord'])) {
    $landlord = $_GET['landlord'];
     ...
     $landlord ='  Previous Landlord Reference Check ';
} 
...
width: 100%;">';
$html .='<tr>';
$html .='<th width="55%" style="background-color: #F59E1D;color: #ffffff; text-align: left; font-size: 10px; font-weight: normal; padding: 12px 0px 12px 25px;">Component Type</th>';
$html .='<th width="24%" style="background-color: #F59E1D;color: #ffffff; text-align: left; font-size: 10px; font-weight: normal;">Component Detail</th>';
$html .='<th width="8%" style="background-color: #F59E1D;color: #ffffff; text-align: left; font-size: 10px; font-weight: normal;">Result</th>';
$html .='<th width="13%" style="background-color: '.$color_code.';color: '.$font_color.'; text-align: center; font-size: 10px; font-weight: normal;">'.$string_status.'</th>';
$html .='</tr>';
$html .='<tbody style="padding: 10px; margin-top: 10px; background-color: #D2D4D1;">';
 
$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Landlord Name</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$landload.'</td>'; 
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Landlord Contact Number</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$number.'</td>'; 
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
/*new*/
$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">How long was the tenancy?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$tenancy_perio.'</td>'; 
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">What was the Monthly rental amount?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$monthly_rental_amoun.'</td>'; 
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Who were the occupants of the property ?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$occupants_propert.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Did the tenant consistently pay rent on time?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$tenant_consistently_pay_rent_on_tim.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Was the utility bills paid on time?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$utility_bills_paid_on_tim.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Did the tenant maintain the rental property well?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$rental_propert.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Were there any major damages or maintenance issues?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$maintenance_issue.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Why did the tenant leave?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$tenant_leav.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Would you rent to this tenant again?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$tenant_rent_agai.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Did the tenant have any pets?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$tenant_pets.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Were there any complaints from neighbors or other tenants?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$complaints_from_neighbor.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">What was the food preference of the Tenant?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$food_preferenc.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">How did the tenant spend their spare time?</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$spare_tim.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';

$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Describe the tenant’s overall character</td>';
$html .='<td style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$overall_characte.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px; ">Verified Date</td>';
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($verified_date).'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html .='<tr>';
$html .='<td class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; margin: 10px 0px 0px 0px; font-weight: bold; font-size: 10px;">Verification Remarks </td>';
$html .='<td colspan="3" style="padding-bottom: 10px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$remark.'</td>';
/*$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';*/
$html .='</tr>';
...
$html .='<tr>';
$html .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px; ">Verification Remarks </td>';
$html .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.$verification_remarks.'</td>';
$html .='<td></td>';
$html .='<td style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html .='</tr>';
...
$html_civil .='<br><div style="padding: 35px 35px 45px 35px;background-color: #e2e5f3;margin-top: 100px; margin-right:80px; margin-left: 80px; line-height:20px; " >';
$html_civil .='<div style="color: #100F0F; font-weight: bold; font-size: 10px;line-height:30px;"> '.$components_array[$index]['component_name'].'</div>';

$html_civil .='<table style="margin-top: 25px;
border-collapse: collapse;
width: 100%;">';
$html_civil .='<tr>';
$html_civil .='<td style="padding-bottom: 15px; width: 15%; font-size: 10px; color: #100F0F;line-height:30px;">Status</td>';
$html_civil .='<td style="padding-bottom: 15px;line-height:30px;width:2%;">:</td>';
$html_civil .='<td style="padding-bottom: 15px; font-weight: bold; font-size: 10px; color: #381653;line-height:30px;">'.$status.'</td>';
$html_civil .='</tr>';
$html_civil .='</table>';
$html_civil .='<table style="margin-top: 25px; color: #ffffff;
border-collapse: collapse;
width: 100%;">';
$html_civil .='<tr>';
$html_civil .='<th width="35%" style="background-color: #F59E1D;color: #ffffff; text-align: left; font-size: 10px; font-weight: normal; padding: 12px; ">Particulars</th>';
$html_civil .='<th width="30%" style="background-color: #F59E1D;color: #ffffff; text-align: left; font-size: 10px; font-weight: normal; "> Details</th>';
$html_civil .='<th width="10%" style="background-color: #F59E1D;color: #ffffff; text-align: left; font-size: 10px; font-weight: normal;">Result</th>';
$html_civil .='<th width="25%" style="background-color: '.$color_code.'; color: #ffffff; text-align: center; font-size: 10px; font-weight: normal; padding: 12px;  ">'.$string_status.' </th>';
$html_civil .='</tr>';

$html_civil .='<tbody style="padding: 10px; margin-top: 10px; background-color: #D2D4D1;">';
...
$html_civil .='<tr>';
$html_civil .='<td width="35%" class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; font-weight: bold; font-size: 10px;line-height:30px;">'.$Address_title_name.'</td>';
$html_civil .='<td width="30%" style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;line-height:20px;">'.$address_sub.'</td>';
$html_civil .='<td width="10%"></td>';
$html_civil .='<td width="25%" style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;line-height:30px;" >'.$address_img.'</td>';
$html_civil .='</tr>';

$html_civil .='<tr>';
$html_civil .='<td width="35%" class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; font-weight: bold; font-size: 10px;line-height:30px;">'.$City_title_name.'</td>
<td width="30%" style="padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;line-height:30px;">'.$city_sub.'</td>';
$html_civil .='<td width="10%"></td>';
$html_civil .='<td width="25%" style="color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;line-height:30px;" >'.$city_img.'</td>';
$html_civil .='</tr>';

$html_civil .='<tr>';
$html_civil .='<td width="35%" class="border-left-green" style="line-height:30px;padding: 10px 0px 10px 40px;color: #381653; font-weight: bold; font-size: 10px;">'.$State_title_name.'</td>';
$html_civil .='<td width="30%" style="line-height:30px;padding-bottom: 5px 0px;font-weight: bold; font-size: 10px; color: #381653;">'.$state_sub.'</td>';
$html_civil .='<td width="10%"></td>';
$html_civil .='<td width="25%" style="line-height:30px;color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$states_img.'</td>';
$html_civil .='</tr>';

$html_civil .='<tr>';
$html_civil .='<td width="35%"  class="border-left-green" style="line-height:30px;padding: 10px 0px 10px 40px;color: #381653; font-weight: bold; font-size: 10px;">'.$Pincode_title_name.'</td>';
$html_civil .='<td width="30%"  style="line-height:30px;padding-bottom: 10px 0px;font-weight: bold; font-size: 10px; color: #381653;">'. $pincode_sub.'</td>';
$html_civil .='<td width="10%" ></td>';
$html_civil .='<td width="25%"  style="line-height:30px;color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$pin_code_img.'</td>';
$html_civil .='</tr>';

$html_civil .='<tr>';
$html_civil .='<td style="padding-bottom:15px;color: #381653; font-weight: bold; font-size: 10px;">Verified Date</td>';
$html_civil .='<td style="padding-bottom: 15px; color: #381653; font-weight: bold; font-size: 10px;">'.get_date($verified_dates).'</td>';
$html_civil .='<td style="padding-bottom: 15px;"></td>';
$html_civil .='<td style="line-height:30px;color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;">'.$check16px.'</td>';
$html_civil .='</tr>';

$html_civil .='<tr>';
$html_civil .='<td width="35%"  class="border-left-green" style="padding: 10px 0px 10px 40px;color: #381653; font-weight: bold; font-size: 10px;line-height:30px;">Verification Remarks </td>';
$html_civil .='<td width="30%"  style="line-height:30px;padding-bottom: 10px 0px;font-weight: bold; font-size: 10px; color: #381653;">'. $remarks.'</td>';
$html_civil .='<td width="10%" ></td>';
$html_civil .='<td width="25%"  style="line-height:30px;color: '.$color_code.'; padding-bottom: 5px 0px; font-weight: bold;text-align: center; font-size: 10px;" >'.$check16px.'</td>';
$html_civil .='</tr>';
...
$html_civil .='<br pagebreak="true" />';
$html_civil .='<div style="padding: 10px 0px 10px 40px; height: auto; background-color: #e2e5f3; margin-top: 40px; margin-right:135px; margin-left: 135px; line-height:30px;" >';
$html_civil .='<h1 style="text-align:center"> Annexure '.($max+1).'</h1>';
           /* if ($key1 !=0) {
                   $html .='<br pagebreak="true" />';
                }*/
                $details = getimagesize($url);
            ...
            width: 100%;line-height:20px;">';
            $html_civil .='<tr>'; 
            $html_civil .='<td align="center" style="padding-bottom: 20px; font-size: 18px;width:100%"><img style=" display: block;margin-left: auto;margin-right: auto;border: 1px solid #555;" '.$height.' src="'.$url.'"></td>'; 
            $html_civil .='</tr>';
            $html_civil .='</table>'; 
        $max++;
$html_civil .='</div>';
