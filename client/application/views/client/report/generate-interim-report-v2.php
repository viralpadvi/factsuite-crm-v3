    ...
    <footer>
        <table class="table">
            <tr>
                ...
                <td class="ftr-tbl-txt-steps">Page </td>
            </tr>
        </table>
        <hr>
                        ...
                        <table>
                            <tr>
                                ...
                                <td class="report-details-td">
                                    <span class="classification-red margin-right-1" style="background : '.$color_codes.'">'.$text_status.'</span>
                                </td>
                            </tr>
                        </table>
                    </td>
...
$html .='<td colspan="2">'.$manager.'</td>';
$html .='<td style="color: '.$color_code.'; " >'.$check16px.'</td>';
$html .='</tr>';
$html .='<tr>';
$html .='<td>10</td>';
$html .='<td >Reporting Manager Designation</td>';
$html .='<td colspan="2">'.$designation.'</td>';
$html .='<td style="color: '.$color_code.'; " >'.$check16px.'</td>';
$html .='</tr>';
