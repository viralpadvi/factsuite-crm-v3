...
/*$sample_attachment_img_path = base_url().'assets/client/images/marks/sample-pdf-attachment.png';
...
$file_name_final = $candidate[0]['candidaetData']['candidate_id'].'-'.trim(strtolower($candidate[0]['candidaetData']['first_name'])).'_'.trim(strtolower($candidate[0]['candidaetData']['last_name'])).'-'.'interime-report.pdf';
    ...
    <main>
       ...
       <div class="container-fluid bg-gray">
            ...
            <tr>
                ...
                <td width="25%" class="tbl-tx3 brd-b brd-r">'.$candidate[0]['candidaetData']['candidate_id'].'</td>
                <td width="25%" class="tbl-tx1 brd-b brd-r">Requested Date</td>
                <td width="25%" class="tbl-tx3 brd-b">'.get_date($candidate[0]['candidaetData']['case_submitted_date']).'</td> 
                  
            </tr>
             <tr>';
                if ($tv_or_ebgv !='1') {
                $html .='<td class="tbl-tx1 brd-r">Date of Joining</td>
                                <td class="tbl-tx3 ">'.get_date($candidate[0]['candidaetData']['date_of_joining']).'</td>';
                }else{
                $html .='<td class="tbl-tx2 brd-r"></td>
                        <td class="tbl-tx3 brd-r"></td>';     
                }
                 $html .='<td class="tbl-tx1 brd-b brd-r">Completed Date</td>
                <td class="tbl-tx3 brd-r">'.get_date($candidate[0]['candidaetData']['report_generated_date']).'</td>
            </tr>
               <tr>
                <td width="25%" class="tbl-tx2 brd-r">Package Name</td>
                <td colspan="3" class="tbl-tx1 td-bg border-r">'.ucwords($data[0]['package_name']).'</td>
                </tr>
                ';
...
$html .='<div class="container-fluid margin-1 bg-gray">
        ...
        <td colspan="3" class="tbl-tx3 brd-b">'.ucwords($data[0]['client_name']).'</td>
        </tr>
      <tr>
        ...
        <td width="25%" class="tbl-tx3 brd-b">'.get_date($candidate[0]['candidaetData']['date_of_birth']).'</td>
      </tr>
      <tr>';
         if ($tv_or_ebgv !='1') {
        ...
        <td class="tbl-tx3 border-r">Mr. '.ucwords($candidate[0]['candidaetData']['father_name']).'</td>
      </tr>
            </table>
        </div>';
...
$html .='<div class="container-fluid margin-1 bg-gray">
   ...
   if (isset($_GET['components'])) {
    ...
    // $this->analystModel->insert_report_component_lists($candidate[0]['candidaetData']['candidate_id'],$component_get);
   }                     
...
if (!in_array($analyst,['0','1','10','8','6','3','9','5'])) {
...
if (!in_array($analyst[$key],['0','1','10','8','6','3','9','5'])) {
...
$html .='<td style="color: '.$color_code.'; "  class="td-bg brd-r">'.$ctc_img.'</td>';
$html .='</tr>';
...
if (!in_array($analyst_value,['0','1','10','8','6','3','9','5'])) {
...
// $file_name = $generate_pdf_details_variable['invoice_pdf_name']; 
 ...
 $this->db->where('candidate_id',$candidate[0]['candidaetData']['candidate_id'])->update('candidate',$candidate_report);
