...
<h1 class="m-0 text-dark">Client Clarification Cases</h1>
          </div>
        </div>
      </div>
    </div>
...
<script>
  ...
  var display_ui_id = '#view-all-cases',
      request_from = 'client-clarification';
</script>
...
<script src="<?php echo base_url() ?>assets/custom-js/case/add-case-v2.js"></script>
<script src="<?php echo base_url() ?>assets/custom-js/case/edit-case-v2.js"></script>