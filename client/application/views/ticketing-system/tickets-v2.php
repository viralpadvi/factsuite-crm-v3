          ...
          <div class="col-md-12 mt-3">
            <div class="table-responsive" id="get-all-tickets-list">
              ...
              <table class=" table table-striped">
                ...
                <tbody class="tbody-datatable"></tbody>
              </table>
            </div>
          </div>
        </div>
...
<script>
  var site_url = 'factsuite-client/ticket-raised-by-me-pagination';
...
<script src="<?php echo base_url() ?>assets/custom-js/ticketing/raise-ticket.js"></script>
<script src="<?php echo base_url() ?>assets/custom-js/pagination/pagination.js"></script>
<script src="<?php echo base_url() ?>assets/custom-js/ticketing/all-tickets.js"></script>
