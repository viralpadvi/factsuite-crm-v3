 <table class=" table table-striped">
    ...
    <tbody class="tbody-datatable" id="get-all-tickets">
      ...
      <tr>
        ...
        <td class="text-center"><a id="view_ticket_details_a<?php echo isset($value['ticket_id'])?$value['ticket_id']:''; ?>" href="javascript:void(0)" onclick="view_ticket_details(<?php echo isset($value['ticket_id'])?$value['ticket_id']:''; ?>)"><img src="<?php echo base_url(); ?>assets/client/assets-v2/dist/img/black-eye.svg"></a></td>
      </tr>
  <?php }
    } else { ?>
